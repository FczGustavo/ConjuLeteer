...
export const SIMULADO_QUESTIONS: SimuladoQuestion[] = [
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "letter": "E",
        "text": "“Ela era mais digna do que eu havia pensado: conseguido o dinheiro, nada mais quis me\ncontar”",
        "correct": false,
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "as formas verbais “mirem” (v. 1), “vivem” (v. 3), “sofrem” (v. 14) e “têm” (v. 16) estão\nconjugadas no mesmo modo e tempo, além de possuírem o mesmo sujeito.",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial A): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      },
      {
        "letter": "B",
        "text": "levando em consideração o contexto, é possível considerar o sentido da palavra\n“fustigadas” (v. 09) como castigadas.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (B) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "C",
        "text": "em “vivem pros seus maridos” (v. 3), o termo sublinhado é classificado pela gramática\nnormativa como adjunto adverbial.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (C) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "D",
        "text": "na última estrofe, em todas as ocorrências, o vocábulo “se” é classificado como pronome\nreflexivo.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (D) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      }
    ],
  ...
  },
  {
    ...
    "questionNumber": 6,
    "readingText": "",
    "statement": "Leia atentamente e assinale a alternativa correta.\nBons tempos aqueles em que a família em férias, no extenso litoral brasileiro, escolhia para locar\numa casa ou um resort por conta da proximidade com o mar, pelo acesso ao comércio e pelas\nbelezas naturais ao redor.\nAdaptado de WAGNER, Carlos. Mesmo sendo um paraíso,  se não tiver internet, não leve os filhos\nnas férias. Observatório da Imprensa, 11/12/2018, edição 1017.\nDisponível em: <http:/ /observatoriodaimprensa.com.br/dilemas-da-imprensa/mesmo-sendo-um-\nparaiso-se-nao-tiver-internet-nao-leve-os-filhos-nas-ferias/> Acesso em ago. 2020\nCaso o período em destaque no enunciado estivesse escrito na voz passiva, deveria ser",
    "options": [
      {
        "letter": "A",
        "text": "Bons tempos, no extenso litoral brasileiro, aqueles em que uma casa ou resort foram\nescolhidos para locação pela família em férias por conta da proximidade com o mar, pelo\nacesso ao comércio e pelas belezas naturais ao redor.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (A) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "B",
        "text": "Bons tempos aqueles em que uma casa ou resort eram escolhidos para serem locados, no\nextenso litoral brasileiro, pela família em férias por conta da proximidade com o mar, pelo\nacesso ao comércio e pelas belezas naturais ao redor.",
        "correct": true,
      ...
      {
        "letter": "C",
        "text": "Bons tempos aqueles em que escolhia, por conta da proximidade com o mar, pelo acesso\nao comércio e pelas belezas naturais ao redor, para locar uma casa ou um resort, a família\nem férias, no extenso litoral brasileiro.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (C) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "D",
        "text": "Bons tempos aqueles em que pela família em férias por conta da proximidade com o mar,\npelo acesso ao comércio e pelas belezas naturais ao redor, uma casa ou resort poderiam\nescolhidos para locar, no extenso litoral brasileiro.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (D) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "E",
        "text": "Bons tempos aqueles em se escolhia para locar uma casa ou um resort por conta da\nproximidade com o mar, pelo acesso ao comércio e pelas belezas naturais ao redor, no\nextenso litoral brasileiro.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (E) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      }
    ],
  ...
  },
  {
    ...
    "listTitle": "PDF 7 • Verbos (Aprofundamento & Concursos)",
    "questionNumber": 8,
    "readingText": "O homem deve reencontrar o Paraíso...\nRubem Alves \nEra uma família grande, todos amigos. Viviam como t odos nós: moscas presas na enorme teia de\naranha que é a vida da cidade. Todos os dias a aran ha lhes arrancava um pedaço. Ficaram\ncansados. Resolveram mudar de vida: um sonho louco:  navegar! Um barco, o mar, o céu, as\nestrelas, os horizontes sem fim: liberdade. Venderam o que tinham, compraram um barco capaz de\natravessar mares e sobreviver tempestades.\nMas para navegar não basta sonhar. É preciso saber.  São muitos os saberes necessários para se\nnavegar. Puseram-se então a estudar cada um aquilo que teria de fazer no barco: manutenção do\ncasco, instrumentos de navegação, astronomia, meteo rologia, as velas, as cordas, as polias e\nroldanas, os mastros, o leme, os parafusos, o motor , o radar, o rádio, as ligações elétricas, os\nmares, os mapas... Disse certo o poeta: Navegar é preciso, a ciência da navegação é saber preciso,\nexige aparelhos, números e medições. Barcos se fazem com precisão, astronomia se aprende com\no rigor da geometria, velas se fazem com saberes ex atos sobre tecidos, cordas e ventos,\n\ninstrumentos de navegação não informam mais ou menos . Assim, eles se tomaram cientistas,\nespecialistas, cada um na sua - juntos para navegar.\nChegou então o momento da grande decisão - para ond e navegar. Um sugeria as geleiras do sul\ndo Chile, outro os canais dos fiordes da Nomega, um outro queria conhecer os exóticos mares e\npraias das ilhas do Pací&co, e houve mesmo quem qui sesse navegar nas rotas de Colombo. E foi\nentão que compreenderam que, quando o assunto era a  escolha do destino, as ciências que\nconheciam para nada serviam. \nDe nada valiam números, tabelas, gráficos, estatísti cas. Os computadores, coitados, chamados a\ndar o seu palpite, ficaram em silêncio. Os computadores não têm preferências - falta-lhes essa sutil\ncapacidade de gostar, que é a essência da vida humana. Perguntados sobr e o porto de sua\nescolha, disseram que não entendiam a pergunta, que  não lhes importava para onde se estava\nindo. \nSe os barcos se fazem com ciência, a navegação faz- se com os sonhos. Infelizmente a ciência,\nutilíssima, especialista em saber como as coisas funciona m, tudo ignora sobre o coração humano.\nE preciso sonhar para se decidir sobre o destino da  navegação. Mas o coração humano, lugar dos\nsonhos, ao contrário da ciência, é coisa imprecisa.  Disse certo o poeta: Viver não é preciso .\nPrimeiro vem o impreciso desejo. Primeiro vem o imp reciso desejo de navegar. Só depois vem a\nprecisa ciência de navegar. \nNaus e navegação têm sido uma das mais poderosas im agens na mente dos poetas. Ezra Pound\ninicia seus Cânticos dizendo: E pois com a nau no mar/assestamos a quilha contra as vagas...\nCecília Meireles: Foi, desde sempre, o mar! A solidez da terra, monót ona/parece-nos fraca ilusão!\nQueremos a ilusão do grande mar/multiplicada em suas malhas de perigo . E Nietzsche: Amareis a\nterra de vossos .lhos, terra não descoberta, no mar  mais distante. Que as vossas velas não se\ncansem de procurar esta terra! O nosso leme nos con duz para a terra dos nossos .lhos ... Viver é\nnavegar no grande mar! \nNão só os poetas: C. Wright Mills, um sociólogo sáb io, comparou a nossa civilização a uma galera\nque navega pelos mares. Nos porões estão os remadores. Remam com precisão cada vez maior. A\ncada novo dia recebem remos novos, mais perfeitos. O ritmo das remadas acelera. Sabem tudo\nsobre a ciência do remar. A galera navega cada vez mais rápido. Mas, perguntados sobre o porto\ndo destino, respondem os remadores: O porto não nos importa. Oque importa é a velocidad e com\nque navegamos.\nC. Wright Mills usou esta metáfora para descrever a  nossa civilização por meio duma imagem\nplástica: multiplicam-se os meios técnicos e cientí &cos ao nosso dispor, que fazem com que as\nmudanças sejam cada vez mais rápidas; mas não temos  ideia alguma de para onde navegamos.\nPara onde? Somente um navegador louco ou perdido navegaria s em ter ideia do para onde. Em\n\nrelação à vida da sociedade, ela contém a busca de uma utopia. Utopia, na linguagem comum, é\nusada como sonho impossível de ser realizado . Mas não é isso. Utopia é um ponto inatingível que\nindica uma direção.\nMário Quintana explicou a utopia com um verso: Se as coisas são inatingíveis... ora!/Não é motivo\npara não querê-las... Que tristes os caminhos, se n ão fora/ A mágica presença das estrelas ! Karl\nMannheim, outro sociólogo sábio que poucos leem, já  na década de 1920 diagnosticava a doença\nda nossa civilização: Não temos consciência de direções, não escolhemos d ireções. Faltam-nos\nestrelas que nos indiquem o destino.\nHoje, ele dizia, as únicas perguntas que são feitas , determinadas pelo pragmatismo da tecnologia\n(o importante é produzir o objeto) e pelo objetivis mo da ciência (o importante é saber como\nfunciona), são: Como posso fazer tal coisa? Como posso resolver este problema concreto\nparticular? E conclui: E em todas essas perguntas s entimos o eco otimista: não preciso de me\npreocupar com o todo, ele tomará conta de si mesmo. \nEm nossas escolas é isso que se ensina: a precisa c iência da navegação, sem que os estudantes\nsejam levados a sonhar com as estrelas. A nau naveg a veloz e sem rumo. Nas universidades, essa\ndoença assume a forma de peste epidêmica: cada espe cialista se dedica, com paixão e\ncompetência, a fazer pesquisas sobre o seu parafuso, sua polia, sua vela, seu mastro. \nDizem que seu dever é produzir conhecimento. Se for em bem-sucedidas, suas pesquisas serão\npublicadas em revistas internacionais. Quando se lh es pergunta: Para onde seu barco está\nnavegando?, eles respondem: Isso não é científico. O s sonhos não são objetos de conhecimento\ncientífico...\nE assim ficam os homens comuns abandonados por aquel es que, por conhecerem mares e\nestrelas, lhes poderíam mostrar o rumo. Não posso p ensar a missão das escolas, começando com\nas crianças e continuando com os cientistas, como outra que não a da realização do dito do poeta:\nNavegar é preciso. Viver não é preciso. \nÉ necessário ensinar os precisos saberes da navegaç ão enquanto ciência. Mas é necessário\napontar com imprecisos sinais para os destinos da navegação: A terra dos filhos dos meus filhos, no\nmar distante ... Na verdade, a ordem verdadeira é a inversa. Pri meiro, os homens sonham com\nnavegar. Depois aprendem a ciência da navegação. E inútil ensinar a ciência da navegação a quem\nmora nas montanhas...\nO meu sonho para a educação foi dito por Bachelard:  O universo tem um destino de felicidade. O\nhomem deve reencontrar o Paraíso. O paraíso é jardim, lugar de felicidade, prazeres e alegrias para\nos homens e mulheres. Mas há um pesadelo que me ato rmenta: o deserto. Houve um momento\n\nem que se viu, por entre as estrelas, um brilho cha mado progresso. Está na bandeira nacional... E,\nquilha contra as vagas , a galera navega em direção ao progresso, a uma ve locidade cada vez\nmaior, e ninguém questiona a direção. E é assim que  as florestas são destruídas, os rios se\ntransformam em esgotos de fezes e veneno, o ar se e nche de gases, os campos se cobrem de lixo\n- e tudo ficou feio e triste. \nSugiro aos educadores que pensem menos nas tecnologias do ensino - psicologias e quinquilharias\n- e tratem de sonhar, com os seus alunos, sonhos de um Paraíso.\nOBS.: O texto foi adaptado às regras do Novo Acordo Ortográfico.",
    "statement": "Com base no texto, responda à questão.\nA falta de certa precisão quanto aos tempos, utiliz am- se algumas locuções verbais que traduzem\nmais adequadamente o aspecto verbal. Assim, a const rução que expressa melhor a noção de\ninício de uma ação aparece no fragmento da alternativa",
    "options": [
      {
        "letter": "A",
        "text": "Mas para navegar não basta sonhar. E preciso saber. São muitos os saberes necessários\npara se navegar.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (A) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "B",
        "text": "Puseram-se então a estudar cada um aquilo que teria de fazer no barco: manutenção do\ncasco, instrumentos de navegação, astronomia, meteorologia, as velas, as cordas, as\npolias e roldanas, os mastros, o leme, os parafusos (...)",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial B): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      },
      {
      ...
      {
        "letter": "E",
        "text": "Não posso pensar a missão das escolas, começando com as crianças e continuando com\nos cientistas, como outra que não a da realização do dito do poeta (...)",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (E) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      }
    ],
  ...
  },
  {
    ...
    "listTitle": "PDF 7 • Verbos (Aprofundamento & Concursos)",
    "questionNumber": 9,
    "readingText": "Laivos de memória \n\"...e quando tiverem chegado, vitoriosamente, ao .m  dessa primeira etapa, mais ainda se\nconvenceram de que abraçaram uma carreira difícil, árdua, cheia de sacrifícios, mas útil, nobre e,\nsobretudo bela.\" \n(NOSSA VOGA, Escola Naval, Ilha de Villegagnon, 1964) \nHA quase 50 anos, experimentei um misto de angústia , tristeza e ansiedade que meu jovem\ncoração de adolescente soube suportar com bravura. \n\nNaquela ocasião, despedi-me dos amigos de infância e da família e deixava para trás bucólica\ncidadezinha da região serrana fluminense. A motivaçã o que me levava a abandonar gentes e\ncoisas tão caras era, naquele momento, suficientemen te forte para respaldar a decisão tomada de\ndar novos rumos a minha vida. Meu mundo de então se  tornara pequeno demais para as minhas\naspirações. Meus desejos e sonhos projetavam horizontes que iam muito além das montanhas que\ncircundam minha terra natal. \nComo resistir a sedução e ao fascínio que a vida no mar desperta nos corações dos jovens? \nHavia, portanto, uma convicção: aquelas despedidas,  ainda que dolorosas - e despedidas são\nsempre dolorosas - não seriam certamente em vão. Nã o tinha dividas de que os sonhos que\nacalentam meu coração pouco a pouco iriam se converter em realidade. \n \nEm março de 1962, desembarcávamos do Aviso Rio das Contas na ponte de atração do Colégio\nNaval, como integrantes de mais uma turma desse tra dicional estabelecimento de ensino da\nMarinha do Brasil. \n \nAinda que a ansiedade persistisse oprimindo o peito  dos novos e orgulhosos Alunos do Colégio\nNaval, nado posso negar que a tristeza, que antes h avia ocupado espaço em nossos corações, era\nnaquele momento substituída pelo contentamento pecu liar dos vitoriosos. E o sentimento de\nperda, experimentado por ocasião das despedidas, pr ovara-se equivocado: As nossas caras\nfamílias de origem agregava-se uma nova, a Família Naval, composta pelos recém-chegados\ncompanheiros; e às respectivas cidades de nasciment o, como a minha bucólica Bom Jardim,\njuntava-se, naquele instante, a bela e graciosa ens eada Batista das Neves em Angra dos Reis,\ncomo mais tarde se agregaria a histórica Villegagnon em meio a sublime baía de Guanabara.\nAo todo foram seis anos de companheirismo e feliz c onvivência, tanto no Colégio como na Escola\nNaval. Seis anos de aprendizagem científica, humanís tica e, sobretudo, militar-naval. Seis anos\nentremeados de aulas, festivais de provas, práticas  esportivas, remo, vela, cabo de guerra,\nnavegação, marinharia, ordem-unida, atividades extr aclasses, recreativas, culturais e sociais, que\ndeixaram marcas indeléveis. \n Estes e tantos outros símbolos, objetos e aconteci mentos passados desfilam hoje, deliciosa e\ninexoravelmente distantes, em meio a saudosos devaneios. \nAinda como alunos do Colégio Naval, os contatos preliminares com a vida de bordo e as primeiras\nidas para o mar — a razão de ser da carreira naval. \nComo Aspirantes, derrotas mais longas e as primeira s descobertas: Santos, Salvador, Recife e\n\nFortaleza! \nFechando o ciclo das Viagens de Instrução, o tão so nhado embarque no Navio-Escola. Viagem\nmaravilhosa! Nós, da Turma Miguens, Guardas-Marinha  de 1967, tivemos a oportunidade ímpar e\nrara de participar de um cruzeiro ao redor do mundo  em 1968: a Quinta Circum-navegação da\nMarinha Brasileira. \n \nApós o regresso, as platinas de Segundo-Tenente, o primeiro embarque efetivo e o verdadeiro\ninício da vida profissional - no meu caso, a bordo do cruzador Tamandaré, o inesquecível C-12. Era\na inevitável separação da Turma do CN-62/63 e da EN-64/67. \n \nNovamente um misto de satisfação e ansiedade tomou conta do coração, agora do jovem\nTenente, ao se apresentar para servir a bordo de um  navio de nossa Esquadra. Após proveitosos,\nmas descontraídos estágios de instrução como Aspira nte e Guarda-Marinha, quando as\nresponsabilidades eram restritas a compromissos cur riculares, as platinas de O&cial começariam,\nfinalmente, a pesar forte em nossos ombros. Sobre es sa transição do status de Guarda-Marinha\npara Tenente, o notável escritor-marinheiro Gastão Penalva escrevera com muita propriedade: \"...é\na fase inesquecível de nosso ofício. Coincide exata mente com a adolescência, primavera da vida.\nTudo são flores e ilusões... Depois começam a despon tar as responsabilidades, as agruras de\nnovos cargos, o acúmulo de deveres novos\".\n \nE esses novos cargos e deveres novos, que foram se multiplicando a bordo de velhos e saudosos\nnavios, deixariam agradáveis e duradouras lembrança s em nossa memória. Com o passar dos\ntempos, inúmeros Conveses e Praça d'Armas, hoje sau dosos, foram se incorporando ao acervo\nprofissional-afetivo de cada um dos integrantes daquela Turma de Guardas-Marinha de 1967. \nAh! Como é gratificante, ainda que melancólico, repa ssar tantas lembranças, tantos termos\nexpressivos, tanta gíria maruja, tantas tradições, fainas e eventos tão intensamente vividos a bordo\nde inesquecíveis e saudosos navios... \nE as viagens foram se multiplicando ao longo de bem  aproveitados anos de embarque, de\ncentenas de dias de mar e de milhares de milhas nav egadas em alto mar, singrando as extensas\nmassas líquidas que formam os grandes oceanos, ou a o longo das Águas costeiras que banham os\nrecortados litorais, com passagens, visitas e arrib adas em um sem número de enseadas, baías,\nbarras, angras, estreitos, furos e canais espalhado s pelos quatro cantos do mundo, percorridos\nnem sempre com mares bonaçosos e ventos tranquilos e favoráveis. \nInúmeros foram também os portos e cidades visitadas , não só no Brasil como no exterior, o que\nsempre nos proporciona inestimáveis é valiosos conh ecimentos, principalmente graças ao contato\ncom povos diferentes e até mesmo de culturas exótic as e hábitos às vezes totalmente diversos\ndos nossos, como os ribeirinhos amazonenses ou os c riadores de serpentes da antiga Taprobana,\n\nex-Ceilão e hoje Siri Lanka. \nComo foi fascinante e delicioso navegar por todos e sses cantos. Cada novo mar percorrido, cada\nnova enseada, estreito ou porto visitado tinha semp re um gosto especial de descoberta... Sim,\npois, como dizia Câmara Cascudo, \"o mar não guarda os vestígios das quilhas que o atravessam.\nCada marinheiro tem a ilusão cordial do descobrimento\". \n(CESAR, CMG (RM1) William Carmo. Laivos de memória.  In: Revista de Villegagnon, Ano IV, n° 4,\n2009. p. 42-50. Texto adaptado)",
  ...
  },
  {
    ...
    "questionNumber": 13,
    "readingText": "ESPERA UMA CARTA \nCarlos Drummond de Andrade \nAgora sei por que não vieste, depois de tanto e tan to te esperar. Cheguei a supor que não\nexistisses. Imaginei, às vezes, que foras ter a out ra porta, e alguém se beneficiava de ti. Era o\nequívoco mais consolador, afinal não se perderia a m ensagem. Eu indagava os rostos, pesquisava\nneles a furtiva iluminação, o traço de beatitude, q ue indicasse conhecimento de teu segredo. Não\ndistinguia bem, as pessoas se afastavam ou escondia m tão &namente tua posse, que a dúvida\nficava enrodilhada à minha esquerda. O desengano, à direita. E não havia combate entre eles.\nCoexistiam, mais a cabeçuda esperança.\nTodas as manhãs te aguardava. Ao meio-dia já era certo que não vinhas. O resto do dia era neutro.\nRestava amanhã. E outro amanhã. E depois. Repousava , aos domingos, dessa expectação sem\nlimites. Via-te aparecer em sonho, e fechava os olh os como quem soubesse que não te merecia,\nou quisesse retardar o instante de comunicação. Esp erar era quase receber. Cismava que te\nrecebera havia longos anos, mas era menino e sem condições de avaliar-te, ou vieras em código, e\neu, sem possuir a chave, me quedava mirando-te e remirando-te como à estrela intocável.\nMuitas recebi durante esse prazo. Não se confundiam  contigo. Traziam palavras boas ou más,\nindiferentes, quaisquer. E o receio de que entre el as rolasses perdida, fosses considerada\ninsignificante? Desprezada, como impresso de propaganda?\n\nAs dádivas que devias trazer-me, quais seriam? Nunc a imaginei ao certo o que de grande me\nreservavas. Quem sabe se a riqueza, de que eu tinha medo, mas revestida de doçura e imaginação,\na resumir os prazeres do despojamento? Ou a glória espiritual, sem seus gêmeos a jactância e o\norgulho? Ou o amor – e esta só palavra me fazia cur var a cabeça, ao peso de sua magnificência.\nEu não escolhia nem hesitava. O dom seria perfeito,  sem proporção com o ente gratificado. E\ninfinito, a envolver minha finitude. \nMas agora sei por que não vieste nem virás. Estavas  entre inúmeras companheiras, jogadas em\nsacos espessos, por sua vez afundados num subterrâneo. E dizer que todos os dias passei por tuas\nproximidades, até mesmo em cima de ti, sem discernir tua pulsação. Servidores infiéis ou cansados\nforam acumulando debaixo do chão o monte de notícia s, lamentos, beijos, ameaças, faturas,\nordens, saudades, sobre o qual os caminhões passava m, os dias passavam, passavam os governos\ne suas reformas. Escondida, esmagada no monte, sem sombra de movimento, lá te deixaste jazer,\nenquanto eu conjeturava mil formas de extravio e om issão. Cheguei a desconfiar de ti, a crer que\nzombavas de minha urgência, distraindo-te por itine rários loucos. Suspeitei que te recusavas,\nquase desejei que fogo ou água te liquidassem, já que te esquivavas a tua missão.\nE foi o que aconteceu, sem dúvida. A umidade e os r atos de esgoto te consumiram. Restam – se\nrestarem – fragmentos que nada contam ou explicam, senão que uma carta maravilhosa, esperada\ndesde a eternidade, por mim e por outro qualquer homem igual a mim, foi escrita em alguma parte\ndo mundo e não chegou a destino, porque o Correio a  jogou fora, entre trezentas mil ou trezentos\nmilhões de cartas. \nOBS.: O texto foi adaptado às regras do Novo Acordo Ortográfico. \nCom base no texto, responda à questão.",
    "statement": "A forma verbal que pertence à segunda conjugação aparece na opção:",
    "options": [
      {
        "letter": "A",
  ...
  },
  {
    ...
    "questionNumber": 15,
    "readingText": "",
    "statement": "“Às crianças daqui de casa tocaram um bicudo e um c anário.” O sentido da forma verbal nessa\npassagem é o mesmo que aparece no exemplo seguinte:",
    "options": [
      {
        "letter": "A",
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "letter": "B",
        "text": "“Guri que finta banco, escritório, repartição, fila, balcão, pedido de certidão, imposto a\npagar, [...]\"",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial B): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      },
      {
      ...
      {
        "letter": "E",
        "text": "“As oportunidades também devem ser oferecidas para que as pessoas pequenas\nsaibam que seu nome é: — gente” \n4000105680",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (E) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      }
    ],
  ...
  },
  {
    ...
    "listTitle": "PDF 7 • Verbos (Aprofundamento & Concursos)",
    "questionNumber": 21,
    "readingText": "A Última Crônica\nFernando Sabino    \n                              \n\n        A caminho de casa, entro num botequim da Gá vea para tomar um café junto ao balcão. Na\nrealidade estou adiando o momento de escrever. A pe rspectiva me assusta. Gostaria de estar\ninspirado, de coroar com êxito mais um ano nesta bu sca do pitoresco ou do irrisório no cotidiano\nde cada um. Eu pretendia apenas recolher da vida di ária algo de seu disperso conteúdo humano,\nfruto da convivência, que a faz mais digna de ser v ivida. Visava ao circunstancial, ao episódico.\nNesta perseguição do acidental, quer num flagrante de esquina, quer nas palavras de uma criança\nou num acidente doméstico, torno-me simples especta dor e perco a noção do essencial. Sem\nmais nada para contar, curvo a cabeça e tomo meu ca fé, enquanto o verso do poeta se repete na\nlembrança: “assim eu quereria o meu último poema”. Não sou poeta e estou sem assunto. Lanço\nentão um último olhar fora de mim, onde vivem os assuntos que merecem uma crônica.\n        Ao fundo do botequim um casal de pretos aca ba de sentar-se, numa das últimas mesas de\nmármore ao longo da parede de espelhos. A compostur a da humildade, na contenção de gestos e\npalavras, deixa-se acrescentar pela presença de uma  negrinha de seus três anos, laço na cabeça,\ntoda arrumadinha no vestido pobre, que se instalou também à mesa: mal ousa balançar as\nperninhas curtas ou correr os olhos grandes de curi osidade ao redor. Três seres esquivos que\ncompõem em torno à mesa a instituição tradicional d a família, célula da sociedade. Vejo, porém,\nque se preparam para algo mais que matar a fome.\n        Passo a observá-los. O pai, depois de conta r o dinheiro que discretamente retirou do bolso,\naborda o garçom, inclinando-se para trás na cadeira, e aponta no balcão um pedaço de bolo sob a\nredoma. A mãe limita-se a ficar olhando imóvel, vaga mente ansiosa, como se aguardasse a\naprovação do garçom. Este ouve, concentrado, o pedi do do homem e depois se afasta para\natendê-lo. A mulher suspira, olhando para os lados,  a reassegurar-se da naturalidade de sua\npresença ali. A meu lado o garçom encaminha a ordem  do freguês. O homem atrás do balcão\napanha a porção do bolo com a mão, larga-o no prati nho – um bolo simples, amarelo-escuro,\napenas uma pequena fatia triangular.\n        A negrinha, contida na sua expectativa, olh a a garrafa de Coca-Cola e o pratinho que o\ngarçom deixou à sua frente. Por que não começa a co mer? Vejo que os três, pai, mãe e filha,\nobedecem em torno à mesa um discreto ritual. A mãe remexe na bolsa de plástico preto e\nbrilhante, retira qualquer coisa. O pai se mune de uma caixa de fósforos, e espera. A filha aguarda\ntambém, atenta como um animalzinho. Ninguém mais os observa além de mim.\n        São três velinhas brancas, minúsculas, que a mãe espeta caprichosamente na fatia do bolo. E\nenquanto ela serve a Coca-Cola, o pai risca o fósfo ro e acende as velas. Como a um gesto\nensaiado, a menininha repousa o queixo no mármore e  sopra com força, apagando as chamas.\nImediatamente põe-se a bater palmas, muito compenetrada, cantando num balbucio, a que os pais\nse juntam, discretos: “Parabéns pra você, parabéns pra você…”\n        Depois a mãe recolhe as velas, torna a guar dá-las na bolsa. A negrinha agarra finalmente o\nbolo com as duas mãos sôfregas e põe-se a comê-lo. A mulher está olhando para ela com ternura\n– ajeita-lhe a &tinha no cabelo crespo, limpa o far elo de bolo que lhe cai ao colo. O pai corre os\nolhos pelo botequim, satisfeito, como a se convence r intimamente do sucesso da celebração. Dá\ncomigo de súbito, a observá-lo, nossos olhos se encontram, ele se perturba, constrangido – vacila,\n\nameaça abaixar a cabeça, mas acaba sustentando o olhar e enfim se abre num sorriso.",
    "statement": "Considere o trecho: \"O pai se mune de uma caixa de fósforos, e espera.\". Aqui, \"espera\" está na\nterceira pessoa do singular do presente do indicati vo. Qual das seguintes opções apresenta um\nverbo no futuro do presente composto do indicativo,  na terceira pessoa do singular, que poderia\nsubstituir \"espera\", ainda que não mantivesse a coerência do texto?",
    "options": [
      {
        "letter": "A",
        "text": "Terá esperado",
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "letter": "C",
        "text": "O tempo é um elemento que pode ser interpretado de maneiras distintas por cada\nindivíduo.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (C) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
  ...
  },
  {
    ...
    "listTitle": "PDF 7 • Verbos (Aprofundamento & Concursos)",
    "questionNumber": 25,
    "readingText": "Texto para responder à questão\n“[...] O fascínio que a linguagem sempre exerceu so bre o homem vem desse poder que permite\nnão só nomear/criar/transformar o universo real, mas também possibilita trocar experiências, falar\nsobre o que existiu, poderá vir a existir e até mes mo imaginar o que não precisa nem pode existir.\nA linguagem verbal é, então, a matéria do pensament o e o veículo da comunicação social. Assim\n\ncomo não há sociedade sem linguagem, não há socieda de sem comunicação. Tudo o que se\nproduz como linguagem ocorre em sociedade, para ser  comunicado e, como tal, constitui uma\nrealidade material que se relaciona com o que lhe é  exterior, com o que existe\nindependentemente da linguagem. Como realidade mate rial - organização de sons, palavras,\nfrases - a linguagem é relativamente autónoma; como  expressão de emoções, ideias, propósitos,\nno entanto, ela é orientada pela visão de mundo, pe las injunções da realidade social, histórica e\ncultural de seu falante. [...]\"\n(Margarida Petter)\nFonte: FIORIN, José Luiz. Introdução à Linguística. São Paulo: Contexto, 2012.",
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "letter": "C",
        "text": "“— Precisa sim, cortei eu ofegante, empurrandoo para a frente.”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (C) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
  ...
  },
  {
    ...
    "listTitle": "PDF 7 • Verbos (Aprofundamento & Concursos)",
    "questionNumber": 28,
    "readingText": "Texto I\nO Trabalho Escravo no Brasil (1500 – 1888)\nA história colonial do Brasil ocorreu entre os sécu los XVI e XIX. Em 1534, quando o rei de Portugal,\nD. João III, dividiu o território em 14 capitanias hereditárias, a colonização efetivamente se iniciou.\nNo início do século XVI, a economia do Brasil baseo u-se na extração de pau-brasil, na produção\nde açúcar, de tabaco e de algodão. O Brasil tornou- se o maior produtor mundial de açúcar da\n\népoca. No final do século XVII, com o declínio das e xportações de açúcar, a economia extrativista\nda colônia adentrou no ciclo do ouro, sempre sob a administração colonial portuguesa. \nA mão de obra escrava foi o pilar das relações de t rabalho no período colonial. Incialmente os\ncolonizadores portugueses se apropriaram da escravi dão indígena já existente entre as tribos\nnativas. Todavia, a escravização dos índios foi di& cultada, especialmente, pelas epidemias de\ndoenças que causaram baixas demográficas intensas, e xtinguindo até aldeias inteiras – o que\nexigia constante substituição de mão de obra na mon tagem dos engenhos de açúcar –, e pelos\ninteresses divergentes existentes entre a Coroa por tuguesa e missionários jesuítas, que\npretendiam torná-los súditos cristãos e força de tr abalho, e os colonos, que se interessavam em\nmantê-los como mão de obra.\nCom a expansão mercantilista portuguesa, em meados do século XVI, o trá&co de escravos negros\nafricanos para o Brasil colônia passou a ser realiz ado para suprir a necessidade de mão de obra.\nEstima-se que 35,3% dos escravos envolvidos no comé rcio triangular entre os continentes\nafricano, europeu e americano vieram para o Brasil,  ou seja, mais de 4 milhões de pessoas de\norigem africana foram escravizadas no País.\nA partir do fim do século XVII, por múltiplos fatore s, inclusive por pressão diplomática do Reino\nUnido em razão de seus interesses econômicos, a ord em social escravista brasileira articulou-se\nentre o intenso tráfico de escravos e o número constante de alforrias. \nEm 1808, o exército do imperador francês Napoleão B onaparte invadiu Portugal e a família real\nportuguesa estabeleceu a sede oficial do Império português no Rio de Janeiro. Em 1815, D. João VI\nelevou o status do Brasil de colônia a Reino Unido de Portugal, Brasil e Algarves. Em 1821, a Corte\nretornou para Portugal e D. Pedro I, herdeiro de D.  João VI, permaneceu no Brasil para governá-lo\ncomo regente.\nEm 1822, sob a ameaça de perda da limitada autonomia política concedida a partir de 1808, líderes\nbrasileiros convenceram D. Pedro I a declarar a ind ependência, tornando-o o primeiro imperador\ndo recém-criado Império do Brasil.\nO período imperial, de 1822 a 1889, além de preserv ar por várias décadas a escravidão (até 1888),\nnão prestigiou o surgimento de um processo de indus trialização e de urbanização da economia\nbrasileira, nem instituiu, por consequência, um Direito do Trabalho no Brasil.\nA Constituição Imperial de 1824 não fazia referênci a a direitos trabalhistas. Tampouco a Lei de\nLocação de Serviços, de 1830, que regulava o contra to de prestação de serviços exercido por\nbrasileiros ou estrangeiros. Somente em 1850 surgiu uma legislação que fez referência ao trabalho,\nao regulamentar a profissão do comerciante; trata-se  do Código Comercial daquele ano,\ndocumento normativo que não estipulava direitos efetivamente trabalhistas. \n\nNo final do período imperial, o País começou a experimentar um surto de progresso, em torno dos\nanos 1880, com a economia e a sociedade se desenvol vendo mais rapidamente do que nas\ndécadas anteriores.\nEntretanto, o fim da escravatura, no País, foi extre mamente lento, bastante gradual e\nsignificativamente tardio, sendo o último dos estado s latino-americanos a abolir a escravidão\ndentro de suas fronteiras.\nEm 1850, foi aprovada a Lei Eusébio de Queiroz, que  estabeleceu medidas para a repressão do\ntrá&co de africanos para o Brasil, sendo que sua pr omulgação é relacionada, sobretudo, às\npressões britânicas sobre o governo brasileiro para  a extinção da escravidão no País. Em 1871, foi\naprovada a Lei do Ventre Livre, que decretava que todos os filhos de escravos nascidos no Brasil, a\npartir daquele ano, seriam considerados livres; e, em 1885, a Lei dos Sexagenários, que garantiu\nliberdade aos escravos com 60 anos de idade ou mais . Por fim, em 1888, foi aprovada a Lei Áurea,\nque decretava a abolição imediata da escravidão no Brasil.\nAlém de promulgar essas leis nacionais, as quais tinham efeitos parciais nos índices de escravatura,\no Governo imperial transferiu o controle da populaç ão escrava e dos homens livres para a\ncompetência dos municípios. A propósito, tanto no I mpério como na primeira República, o\nGoverno central delegava parcelas importantes de poder aos governos locais, com isso elevando o\nseu poder sobre as populações; em contrapartida, recebia o pleno apoio dos coronéis municipais.\nO Brasil foi o último país ocidental a abolir o&cia lmente a escravatura, que ocorreu com a Lei\nÁurea, de 13 de maio de 1888. \nA abolição da escravatura, todavia, restringiu-se a  conceder liberdade formal aos ex-escravos,\nsem implementar quaisquer políticas públicas inclus ivas relacionadas, como, por exemplo, a\nreforma agrária, a ampliação do mercado de trabalho  para os libertos, o acesso à educação, à\nsaúde etc. Se partirmos da premissa de que, “como a lguns estudos recentes demonstraram, a\nliberdade era (e é) não uma categoria clara e de&ni da, mas, ao invés disto, um emaranhado de\nconcepções sobre direitos e proteções”, poder-se-ia  a&rmar que nem a prerrogativa básica de\ncidadania, a liberdade, foi efetivamente concedida.\nA despeito das inúmeras discussões historiográficas que permeiam o estudo da escravidão no\nBrasil, o fato é que o Brasil tem a sua história ma rcada por quase quatro séculos de escravidão,\ncaracterizados pela ausência de garantia de direito s humanos básicos, exploração, violência e\nsegregação racial e social.\n(Disponível em <https:/ /www.tst.jus.br/memoriaviva/ -\n\n/asset_publisher/LGQDwoJD0LV2/content/ev-jt-80-02> Acesso em 31 mai. 2022)",
    "statement": "Dentre as alternativas apresentadas a seguir, assin ale aquela em que há construção de partícula\n“se” como pronome integrante do verbo.",
    "options": [
      {
        "letter": "A",
        "text": "“Estima-se que 35,3% dos escravos envolvidos no comércio triangular entre os\ncontinentes africano, europeu e americano vieram para o Brasil”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (A) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
      ...
      {
        "letter": "C",
        "text": "“(...) torná-los súditos cristãos e força de trabalho, e os colonos, que se interessavam em\nmantê-los como mão de obra.”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (C) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "D",
        "text": "“No início do século XVI, a economia do Brasil baseou-se na extração de pau-brasil, na\nprodução de açúcar, de tabaco e de algodão.”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (D) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      }
    ],
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "“No final do período imperial, o País começou a experimentar um surto de progresso, em\ntorno dos anos 1880 (...)”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (A) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "B",
        "text": "“(...) o tráfico de escravos negros africanos para o Brasil colônia passou a ser realizado para\nsuprir a necessidade de mão de obra.”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (B) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "C",
        "text": "“(...) e pelos interesses divergentes existentes entre a Coroa portuguesa e missionários\njesuítas, que pretendiam torná-los súditos cristãos e força de trabalho (...)”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (C) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "D",
        "text": "“Todavia, a escravização dos índios foi dificultada, especialmente, pelas epidemias de\ndoenças (...)”",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial D): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      }
    ],
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "“Foi quando ela, a dois palmos de mim, piscou um olho e franziu lascivamente os lábios\nnuma careta, como um simulacro de beijo.”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (A) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "B",
        "text": "“Nesse espírito é que eu voltava para casa pelas ruas desertas, pensando na morte do\namigo e na morte em si, com uma certeza de sua existência inexorável.”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (B) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "C",
        "text": "“Em noites assim, a nossa realidade interior se mistura à atmosfera que o fog torna ainda\nmais densa, apagando os contornos da vida.”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (C) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "D",
        "text": "“Foi em Londres. Eu vinha de uma reunião em que tivera a notícia da morte de um amigo\nno Rio.”",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial D): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      },
      {
        "letter": "E",
        "text": "“Uma noite escura, chuvosa, permeada de neblina — dessas noites londrinas que\nimpregnam nossa alma de tédio e abatimento.”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (E) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      }
    ],
  ...
  },
  {
    ...
    "listTitle": "PDF 7 • Verbos (Aprofundamento & Concursos)",
    "questionNumber": 31,
    "readingText": "Texto \n– Maria!\nA desgraçada estremeceu; e com as mãos hirtas, esti radas, afastou de si o rosto que se inclinara\nsobre ela. Nas torturas do pesadelo, parecia-lhe qu e beiços roxos, sedentos e viscosos lhe\nbuscavam os lábios...\n\n– Maria, sou eu... – repetiu Milkau.\nEla abriu os olhos e ficou deslumbrada. A sua mão ag ora branda e lânguida tateava incerta para se\ncertificar da súbita e estranha aparição do amigo. E  gestos infantis e leves roçavam pela barba de\nMilkau numa inconsciente carícia...\n– Vamos! Levanta-te... – disse-lhe ele, baixo e com  &rmeza, sacudindo o morno carinho,\nrecolhendo e enfeixando com energia as suas forças mais intensas.\nObedecendo, Maria ergueu-se; e pela mão de Milkau f oi seguindo pela casa meio escura. No\ncorredor, a claridade da noite, que entrava pela porta da rua, aberta como de costume, deixava ver\no corpo de um soldado negro dormindo numa postura b rutal, como uma figura tosca e arcaica. A\nprisioneira alarmada quis recuar; Milkau tomou-lhe as mãos com império e passou com ela sereno\ne forte ao lado da sentinela, conduzindo-a para a noite e para a liberdade.\nFora, o ar sutil e frio que lhe penetrava nas carne s sonolentas e tépidas, o céu cristalino, a\ncintilação das estrelas, a largueza, a imensidade do espaço davam à fugitiva uma deliciosa\nvertigem, e, num esmorecido colapso, ela vacilou e veio se apoiar nos braços de Milkau, que a foi\narrastando vagarosamente.\nEnlaçados, caminhavam pela cidade calada e adormeci da. Iam morosos; os passos dela eram\nvacilantes, e os pés, por tanto tempo entorpecidos,  tropeçavam nas pedras soltas da rua. O\nsilêncio inquietador enchia-lhe o espírito do antigo pavor que se não extingue nunca. Uma ou outra\nvez, cães sonolentos despertavam com o passar dos v ultos, e ladrando se arremessavam em vão\ncontra eles. E depois tudo voltava ao sossego ameaç ador, que parecia ser a cada instante\nbruscamente interrompido pelas vozes da perseguição  surgindo das casas acordadas... Mas só\nlhes chegava o chiar monótono e eterno da cachoeira . Dobraram de cautela, espiando com os\nolhos imensos e dilatados pela treva, as formas apagadas e sinistras do mundo. Era no ouvido delas\nassustadiça e trêmula, que Milkau ia falando:\n– Fujamos para sempre de tudo o que te persegue; va mos além, aos outros homens, em outra\nparte, onde a bondade corra espontânea e abundante, como a água sobre a terra. Vem... Subamos\nàquelas montanhas de esperança. Repousemos depois na perpétua alegria... Vamos... corre...\nDeixaram a cidade, e agora sem receio de despertá-l a galgavam a montanha, lépidos e radiantes.\nA fria rigidez, criada pelo terror, se fora dos bra ços de Maria, que se prendiam aos de Milkau,\ntépidos e brandos.\nSubindo, perdiam eles de instante a instante a vist a do Cachoeiro, embaixo aos seus pés, coberto\npelo manto cinzento e vaporoso da bruma, sobre que passava a luz exausta da noite úmida,\nlevantando ali uma fosforescência vaga de nebulosa. .. E debaixo desse manto se desenhavam\nseres fantásticos, colossais, gigantescos, sem form a ainda imaginada... Um trecho do Santa Maria,\nlívido, morto, cortava como um gládio fumegante a v árzea do Queimado, onde as colinas baixas\nsemelhavam corpos deitados de heróis antigos e muti lados, corcundas e aleijões... Depois, nada\nmais viram; subiram ainda e entraram no bojo da mat a. Os braços de Maria retesaram-se de novo\ne apertaram os de Milkau. Havia um rumor contínuo e  aflitivo de vento mau nas folhas da grande\nmassa. Iam inquietos, afundando os olhos na in&ndáv el negrura, donde vinha o clamor do mistério\ne do sofrimento das árvores castigadas. E o vento i mplacável ia passando, fazendo-as gemer\n\nrumorosamente... No vão das trevas, de espaço a esp aço, pelas frestas descia a claridade, e do\njorro de luz se formava dentro da floresta uma colun a alevantada do chão para o céu,\natravessando o teto ondeante, e docemente iluminada  pelos reflexos das árvores espectrais...\nEstreitados um ao outro, aspirando o aroma capitoso  e perturbador que se desprendia das flores\nnoturnas, caminhavam velozes. Milkau repetia no ouvido da companheira o seu apelo de sedução.\n– É a felicidade que te prometo. Ela é da Terra, e havemos de achá-la... Quando vier a luz,\nencontraremos outros homens, outro mundo, e aí... É a felicidade... Vem, vem...\n(Graça Aranha. Canaã. Fragmento.)",
    "statement": "Assinale a alternativa em que há construção de voz em que o sujeito pratica, em si mesmo, a ação\nverbal.",
    "options": [
      {
        "letter": "A",
        "text": "“Obedecendo, Maria ergueu-se; e pela mão de Milkau foi seguindo pela casa meio\nescura.”",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial A): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      },
      {
      ...
      {
        "letter": "C",
        "text": "“Estreitados um ao outro, aspirando o aroma capitoso e perturbador que se desprendia\ndas flores noturnas, caminhavam velozes.”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (C) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
      ...
      {
        "letter": "E",
        "text": "“Ela é da Terra, e havemos de achá-la... Quando vier a luz, encontraremos outros homens,\noutro mundo, e aí...”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (E) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      }
    ],
  ...
  },
  {
    ...
    "questionNumber": 32,
    "readingText": "",
    "statement": "Em qual das alternativas a seguir há voz verbal igu al à encontrada em “ Mudam-se os planos\nhabituais do conhecimento como numa acrobacia aérea.”",
    "options": [
      {
        "letter": "A",
  ...
  },
  {
    ...
    "listTitle": "PDF 7 • Verbos (Aprofundamento & Concursos)",
    "questionNumber": 35,
    "readingText": "“Nunca passamos por situação tão séria”, diz especialista sobre a fome no Brasil\nÚltimos dados da Rede Penssan apontaram para 19 mil hões de brasileiros passando fome; 55%\ndas famílias estão em insegurança alimentar\nLeonardo Lopes\nDados divulgados recentemente pela Rede Brasileira de Pesquisa em Soberania e Segurança\nAlimentar e Nutricional (Rede Penssan) apontaram qu e o Brasil tem pelo menos 19 milhões de\npessoas passando fome, e 55% das famílias estão em insegurança alimentar – sem acesso regular\ne permanente a alimentos.\nA professora da Escola de Nutrição da UFBA destacou  que, diante da instabilidade do ambiente\neconômico e ausência de perspectivas de mudança no curto prazo, dois conceitos são\nfundamentais: solidariedade e responsabilidade do Estado.\n\n“A solidariedade tem sido fundamental para garantir  a sobrevivência desses milhões de brasileiros\nque passam fome. Temos 119 milhões de brasileiros c om alguma privação alimentar, e 19 milhões\npassando fome, sem saber quando voltará a se alimen tar. A solidariedade é fundamental, mas\ninsuficiente”, disse.\nPor ser insuficiente, Sandra Chaves afirma que há uma necessidade do Estado ter responsabilidade\ne garantir programas de transferência de renda dign os. Ela pontua que o valor da cesta básica de\nalimentos cresceu mais de 30% nos últimos 12 meses,  chegando a preços acima de 700 reais em\nalguns estados.\nA pesquisadora explica que os dados desse levantame nto divulgado pela Rede Penssan foram\ncolhidos em dezembro de 2020. “Estava vigente o aux ílio de 300 reais para um número\nrelativamente grande de pessoas e famílias. Depois disso, ficamos três meses sem nenhum auxílio,\ndepois ele retornou num valor muito baixo. Agora, e stamos nesse vazio até ser retomado no valor\nque está previsto de 400 reais”, declarou Sandra.\nAlém da solidariedade da sociedade, e da responsabi lidade estatal em programas de transferência\nde renda, a vice-coordenadora da Rede Penssan a&rma  que são necessárias medidas ativas do\ngoverno na regulamentação de preços, para garantir o acesso da população aos alimentos, além\nde programas de emprego e renda.\n“Ter um botijão do gás a R$ 120 é muito grave. O qu ilo do feijão e arroz a R$ 9 em algumas\ncapitais. O preço absurdo do quilo da carne. Em 197 4, foi feito o primeiro estudo nacional de\ndespesa familiar. Lá, foi demonstrado uma situação de fome desse nível que estamos vendo agora.\nFamílias faziam sopa de papelão pelo país. Nós esta mos vendo isso agora. Nunca passamos por\numa situação tão seria”, afirmou Sandra Chaves.\n(Disponível em <https:/ /www.cnnbrasil.com.br/saude/ nunca-passamos-por-situacao-tao-seria-\ndiz-especialista- sobre-a-fome-no-brasil/> Acesso em 06 jan. 2021)",
    "statement": "Assinale, a seguir, a alternativa em que há elipse de um verbo anteriormente presente no contexto.",
    "options": [
      {
        "letter": "A",
        "text": "“Além da solidariedade da sociedade, e da responsabilidade estatal em programas de\ntransferência de renda, a vice-coordenadora da Rede Penssan afirma que são necessárias\nmedidas ativas do governo na regulamentação de preços, para garantir o acesso da\npopulação aos alimentos, além de programas de emprego e renda.”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (A) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "B",
        "text": "“Por ser insuficiente, Sandra Chaves afirma que há uma necessidade do Estado ter\nresponsabilidade e garantir programas de transferência de renda dignos. Ela pontua que o\nvalor da cesta básica de alimentos cresceu mais de 30% nos últimos 12 meses, chegando a\npreços acima de 700 reais em alguns estados.”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (B) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "C",
        "text": "‘(...) “Temos 119 milhões de brasileiros com alguma privação alimentar, e 19 milhões\npassando fome, sem saber quando voltará a se alimentar. A solidariedade é fundamental,\nmas insuficiente”, disse.’",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial C): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      },
      {
        "letter": "D",
        "text": "“A professora da Escola de Nutrição da UFBA destacou que, diante da instabilidade do\nambiente econômico e ausência de perspectivas de mudança no curto prazo, dois\nconceitos são fundamentais: solidariedade e responsabilidade do Estado.”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (D) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      }
    ],
  ...
  },
  {
    ...
    "statement": "Tendo em vista outros empregos da expressão sublinh ada, deve ocorrer o uso do acento grave\nsomente em:",
    "options": [
      {
        "letter": "A",
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "letter": "B",
        "text": "Conheci uma moça que escondia como um crime certa feia cicatriz de queimadura que\ntinha no corpo.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (B) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "C",
        "text": "Antigamente havia as doenças secretas, que só se nomeavam em segredo ou\nsobpseudônimo.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (C) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "D",
        "text": "Falava daquilo com mal disfarçado orgulho, como se ter coração defeituoso fosse uma\ndistinção aristocrática [... ].",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (D) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "E",
        "text": "Mulheres discutem com prazer seus casos ginecológicos; uma diz abertamente que já não\ntem um ovário [... ].\n4000070919",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (E) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      }
    ],
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "[... ] uma distinção aristocrática que se ganha de nascença e não está ao alcance de\nqualquer um.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (A) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "B",
        "text": "[...] mas a má formação interna é marca de originalidade, que se descreve aos outros com\nevidente orgulho.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (B) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "C",
        "text": "Antigamente havia as doenças secretas, que só se nomeavam em segredo ou sob\npseudônimo.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (C) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
  ...
  },
  {
    ...
    "listTitle": "PDF 7 • Verbos (Aprofundamento & Concursos)",
    "questionNumber": 39,
    "readingText": "OS BICHOS QUE AMAMOS TANTO\nQualquer um de nós que habitualmente faça exercício s físicos nos parques conhece dois grupos\nde frequentadores que dividem conosco o prazer do s ol de inverno: os que se dedicam aos gatos\ne os que se dedicam aos cachorros. Cruzo, diariamen te, com uma senhora que conversa com o\nseu \"Alfredo, querido\", que ouve, com paciência, queixas sobre netos ausentes ou sobre os efeitos\nde um milagroso diurético! Outras senhoras alimenta m, com cuidados maternos, gatos vira-latas.\nOs bichos parecem estar ali para nos lembrar que, s e ao longo de milhares de anos, eles puderam\nviver sem os homens, nós, ao contrário, não pudemos  viver sem eles, de quem fomos em muitos\ncasos vítimas.\n\n\"O gato — brinca o antropólogo Marcel Mauss — foi o  único animal que domesticou o homem.\"\nBrinca por saber que o felino permanece como uma es pécie de \"prisioneiro selvagem\". Animal\nfilosófico, tranquilo, independente, senhor de seus h ábitos, pode tornar-se um amigo, nunca um\nescravo. Sua história é tão enigmática quanto sua i magem. Seu ancestral tinha entre 8 e 18 quilos.\nE quase um metro de comprimento.\nSeus primeiros retratos aparecem nos sarcófagos e p irâmides egípcias. Visto como enviado dos\ndeuses pela proteção que dava às crianças e aos ali mentos da casa, lutando contra cobras e ratos,\ntinha tanta importância entre egípcios que, se um g ato morresse, toda a família ficaria enlutada,\nraspando as sobrancelhas em sinal de dor. Em caso de incêndio, salvava-se, primeiro, o totêmico\nbichano. Se alguém, de propósito ou sem querer, matasse um deles, era passível de condenação à\nmorte por apedrejamento. No mundo muçulmano, Maomé tinha uma gata — a bela Buezza —, e\nos felinos eram identificados com a lua que brilha sobre os desertos e os djins, espíritos aéreos.\nPor outro lado, as tradições indo-europeias preferiram transmitir a imagem do selvagem predador,\npreguiçoso durante o dia para melhor viver à noite.  Noite identificada, no imaginário de nossos\nantepassados, com os demônios, vampiros e feiticeir as. Compreende-se que o cristianismo,\nvitorioso no mundo ocidental, tenha desenvolvido uma viva desconfiança em relação a um animal\nvindo das sombras do mundo pagão, habitado pela lux úria tentadora das filhas de Eva, donas,\ncomo os gatos, de uma pelugem afrodisíaca, capaz de  fazer sucumbir o homem, representado\npelo honesto cão.\nO cachorro, por sua vez, depende da ação humana... e por isso desempenha tantas e tão\ndiversificadas funções: late à noite, vigia residênc ias, fareja drogas, guia cegos, busca o jornal, faz\nanúncios para a televisão e, é bom não esquecer, fo i pioneiro nas viagens espaciais. É graças a\nessa formidável colaboração que marcou tanto nossa vida e nosso vocabulário: \"fiel como um\ncão\", \"cão que ladra não morde\", \"cachorro bom de tatu, morre de cobra\".\nSua personalidade e seu psiquismo variam ao infinito, às vezes tão sutil quanto o do seu dono, pois\n\"tal dono, tal cão\". Hoje herói de cinema, multipli ca-se em Rintintins, Milous, Snoopys e Plutos,\ndeixando para trás a imagem de lutadores aguerridos  que enfrentavam, nas arenas romanas, ursos\ne leões ou, nas feiras medievais, touros e bois bra vos. Pinturas na Espanha comprovam que sua\ndomesticação teria ocorrido há cerca de 10 mil anos . Escavações arqueológicas revelam que eram\nenterrados junto com seus donos e, entre o Egito e a Grécia, os cultos ao deus Chacal e a Argos\n— o cão de Ulisses — comprovam a fecundidade das representações sobre a ligação homem/cão.\nMas ele também inspira sentimentos contraditórios. Isso porque nossa sociedade vem dando um\nlugar especial aos animais domésticos. Muitas vezes  ter cachorro ou gato pode, também,\nfuncionar como derivativo para a solidão e a insegu rança. A necessidade de autoridade, de\ndominação, de apropriação, bem como a angústia, a a gressividade, a riqueza de uma vida\n\nexcessivamente interiorizada ou a timidez e dificuldade de comunicação, as frustrações afetivas ou\nsexuais de um casal desunido, separado ou sem crian ças, a velhice em que as pessoas se sentem\nabandonadas pelos filhos, o narcisismo, mas também a s tensões sociais e profissionais, todas\nessas motivações geradoras de desequilíbrio podem l evar à aquisição de um cachorro,\nresponsabilizado em alguns casos por comportamentos antissociais.\nAs prefeituras, por sua vez, têm de enfrentar consi deráveis tarefas de limpeza. Em Paris,\nprovavelmente cidade recordista, são 2 mil tonelada s de caca e urina por dia! Nova York\nradicalizou: os americanos não podem circular sem e star munidos de sacos para recolher os\ndejetos do melhor amigo, cujas infrações, aliás, mo ntam a US$ 100. Nas nossas grandes cidades, a\niniciativa fica por conta de associações de bairros ou de proprietários mais zelosos com o bem\ncomum. A verdade é que, a despeito dos inconvenient es, das despesas, da irritação crescente da\ncoletividade pela falta de campanhas publicitárias que eduquem donos, cães e gatos seguem se\nmultiplicando.\nVerdadeiros lembretes para a solidão, o abandono e a insegurança em que vivem alguns dos\ncidadãos das metrópoles, podiam usar sua simpática imagem para lembrar aos donos expressões\ncomo: \"limpo como um gato\" ou \"totó educado não suj a a casa do dono\", evitando que deliciosos\nquadrúpedes como o pachorrento Alfredo nos obrigassem a lavar o tênis a cada vez que voltamos\ndo parque!",
    "statement": "Assinale, a seguir, a alternativa em que há oração reduzida e não locução verbal no trecho\ndestacado.",
    "options": [
      {
        "letter": "A",
        "text": "“Os bichos parecem estar ali para nos lembrar que, se ao longo de milhares de anos, eles\npuderam viver sem os homens, nós (...)”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (A) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "B",
        "text": "“Animal filosófico, tranquilo, independente, senhor de seus hábitos, pode tornar-se um\namigo, nunca um escravo.”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (B) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
      ...
      {
        "letter": "D",
        "text": "“(...) os americanos não podem circular sem estar munidos de sacos para recolher os\ndejetos do melhor amigo, cujas infrações, aliás, montam a US$ 100.”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (D) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "E",
        "text": "“Verdadeiros lembretes para a solidão, o abandono e a insegurança em que vivem alguns\ndos cidadãos das metrópoles, podiam usar sua simpática imagem (...)”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (E) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      }
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "letter": "C",
        "text": "“Foi considerado agora em 2013, por uma pesquisa do jornal A Tarde, da Bahia, como o\nmaior baiano de todos os tempos (...)”",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial C): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      },
      {
      ...
      {
        "letter": "E",
        "text": "“— Como vai aquela terra maravilhosa? Copacabana continua linda? Como vai o\npresidente Afonso Pena?”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (E) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      }
    ],
  ...
  },
  {
    ...
    "listTitle": "PDF 7 • Verbos (Aprofundamento & Concursos)",
    "questionNumber": 43,
    "readingText": "Por que o frio é ideal para comer pratos mais calóricos\n30 de jun de 2021\nAlém de usar mais camadas de roupas, temos mecanism os corporais que são ativados para nos\nmanter aquecidos\nEm 1937, uma dupla de pesquisadores nos EUA buscou determinar a zona de termoneutralidade\nde seres humanos, ou a temperatura do ambiente em q ue a nossa produção de calor basal\ncorresponde ao necessário e suficiente para que nossos corpos se mantenham na sua temperatura\nnormal de funcionamento, de cerca de 37°C. Descobri ram que para homens nus (o estudo não\nenvolveu mulheres) sem nenhuma atividade física, te mperaturas ambientes de cerca de 30°C os\nmantinham termoneutros. Nesta temperatura e condiçõ es, não se observava a ativação de\nestratégias para aumentar nem diminuir a temperatur a corporal – a produção de suor, por\nexemplo, é uma forma de evitar superaquecimento.\nQuando estamos vestidos, as roupas retêm significativamente o calor gerado pelos nossos corpos.\nEsse fator, aliado à presença de algum tipo de movi mentação física, determina que a temperatura\nde ambientes internos em que a maioria das pessoas se sente confortável é entre 20°C e 25°C\n(dependendo de características da pessoa e da vestimenta usada).\nBoa parte do Brasil, nesta semana, se encontra com temperaturas significativamente inferiores a\n20°C. E boa parte do Brasil não possui calefação em  ambientes internos, realidade que causa\nespanto em muitos visitantes estrangeiros, ao se da rem conta que passam mais frio aqui do que\nem países temperados, pelo simples fato de serem ex postos a temperaturas baixas o tempo todo.\nMas isso não significa que todos vamos ver nossos co rpos esfriar abaixo dos 37°C, pois, além de\nnos vestirmos com mais camadas de roupas para evitar a perda de calor dos nossos corpos, temos\nmecanismos que podem ser ativados para nos manter aquecidos.\n\nUm mecanismo para manter nossos corpos aquecidos é evitar a perda de calor através da\nvasoconstrição periférica, ou a diminuição da chega da de sangue (quente) nos vasos das nossas\nextremidades, como mãos e pés, onde o calor pode ser perdido para o ambiente. Esse mecanismo\npoupa o calor para as partes centrais do corpo, ond e também ficam os órgãos mais vitais. É por\ncausa desta constrição de vasos que nossas mãos e p és ficam gelados quando estamos com frio.\nÉ também por causa deste mecanismo que a mania de e stabelecimentos brasileiros de aferir a\ntemperatura corporal no punho dos clientes em vez da testa é inapropriada, além de anticientífica.\nFragmento retirado de nexojornal.com.br",
    "statement": "Assinale, a seguir, a alternativa em que há construção de agente da passiva.",
    "options": [
      {
        "letter": "A",
        "text": "“Quando estamos vestidos, as roupas retêm significativamente o calor gerado pelos\nnossos corpos.”",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial A): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      },
      {
        "letter": "B",
        "text": "“Esse fator, aliado à presença de algum tipo de movimentação física, determina que a\ntemperatura de ambientes internos em que a maioria das pessoas se sente confortável é\nentre 20°C e 25°C (...)”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (B) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "C",
        "text": "“Nesta temperatura e condições, não se observava a ativação de estratégias para\naumentar nem diminuir a temperatura corporal – a produção de suor, por exemplo, é uma\nforma de evitar superaquecimento.”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (C) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "D",
        "text": "“Descobriram que para homens nus (o estudo não envolveu mulheres) sem nenhuma\natividade física, temperaturas ambientes de cerca de 30°C os mantinham termoneutros.”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (D) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "E",
        "text": "“Em 1937, uma dupla de pesquisadores nos EUA buscou determinar a zona de\ntermoneutralidade de seres humanos (...)”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (E) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      }
    ],
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "“Um texto pode se prolongar e sofrer diversas revisões, um filme pode ser editado e\nreeditado tantas vezes quanto necessário (...)”",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial A): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      },
      {
        "letter": "B",
        "text": "“A tempo de manter a integridade da obra. A eternidade da obra. Sua genialidade, se ela a\ntiver.”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (B) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "C",
        "text": "“Como saber se o corte de dois parágrafos deixaria um conto de Dalton Trevisan ainda\nmais preciso?”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (C) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "D",
        "text": "“Não há um alarme sonoro que avise que chegamos ao limite, ainda mais em se tratando\nde arte.”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (D) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "E",
        "text": "“Parar a tempo uma discussão antes que acabe em pancadaria. Parar a tempo uma relação\ndesgastada, antes que os dois comecem a se odiar.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (E) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      }
    ],
  ...
  },
  {
    ...
    "listTitle": "PDF 7 • Verbos (Aprofundamento & Concursos)",
    "questionNumber": 47,
    "readingText": "Texto I\n\nPortões fechados e alunos distantes das salas de au las. Esse cenário com milhares de escolas\nfechadas em diversos países não se repetia desde a Segunda Guerra Mundial, evidenciando\nnovamente todo o zelo que devemos ter com o ensino,  que desta vez foi escancarado pela\nrelação indireta entre Educação e Coronavírus.\nDe acordo com a Organização das Nações Unidas para a Educação, a Ciência e a Cultura\n(UNESCO), agência da ONU responsável por acompanhar  e apoiar a educação, comunicação e\ncultura no mundo, a pandemia da COVID-19 já impacto u os estudos de mais de 1,5 bilhão de\nestudantes em 188 países – o que representa cerca de 91% do total de estudantes no planeta.\nEm meio a esse panorama assustador e conturbado, nã o apenas na questão de saúde mas\ntambém do aprendizado das crianças e dos jovens, os  impactos no ensino são vários. Enquanto\nalguns escancaram alguns problemas na área da Educa ção, outros podem ser oportunidades de\ncrescimento e evolução, basta que saibamos trabalha r de maneira coordenada, colaborativa e\ninovadora.\nNesta matéria discutiremos exatamente isso: os prin cipais malefícios e benefícios trazidos pelo\nCoronavírus para as nossas escolas, quais pontos pr ecisamos corrigir com urgência e quais\ncaminhos podemos seguir com os ensinamentos trazido s pelas dificuldades que estamos\nenfrentando.\nOs impactos negativos do Coronavírus na Educação\nDespreparo das escolas, professores e alunos\nA verdade é que, para não dizer ninguém, pouquíssim as pessoas imaginavam uma pandemia com\nas proporções que a COVID-19 alcançou. Como consequ ência disso, praticamente organização\nnenhuma estava preparada para lidar com as consequê ncias naturais impostas pelo\ndistanciamento e isolamento social.\nInúmeros setores estão sofrendo para se adaptar e e ncontrar formas de superar essa situação\natribulada. A área da Educação não teria como escap ar desses enormes desafios, os quais\nmostram o despreparo de toda a comunidade escolar p ara um cenário em que a tecnologia pode\nser um instrumento facilitador do processo de aprendizagem. \nA maioria das escolas não conta com o suporte neces sário para o oferecimento do ensino remoto\nou a distância. Apesar de até estarem mais presente s em instituições do Ensino Superior, as\nplataformas digitais eram aproveitadas pela minoria  dos estudantes da Educação Básica. E do dia\npara a noite as escolas precisaram encontrar maneiras de se adaptar a essas “novas tecnologias” –\nque não são tão novas assim.\n\nAlém disso, são poucos os professores que tiveram a formação adequada para lecionar a distância.\nPreparar uma aula remota é bem diferente da prática  presencial de sala de aula – e nós já\npublicamos um artigo completo explicando como monta r planos de aulas remotas –, a dinâmica\nde interação com os alunos é outra, as formas de co municação com familiares muda e o\nconhecimento das tecnologias educacionais é imprescindível.\nAs crianças e os jovens também não estavam acostuma dos a rotinas mais pesadas de estudos em\ncasa, ambiente no qual normalmente priorizavam ativ idades de descanso e entretenimento. De\nmaneira geral, os estudantes não possuíam a maturid ade para lidar com a autonomia implícita no\nensino a distância, em especial os alunos da Educação Infantil e do Ensino Fundamental.\nAs dificuldades são várias, mas são normais. Não devemos nos assustar, esse cenário de educação\ne coronavírus é novo para todos. O importante é que  saibamos, com humildade, identificar essas\nfalhas e dediquemos esforços para corrigi-las.\nEducação e Coronavírus: As famílias estavam distantes da escola\nO afastamento das escolas, levando as crianças e os  jovens a estudarem em casa, mostrou em\nmuitos casos o quanto as famílias estavam até então afastadas da escola e do aprendizado de seus\nfilhos. Ao terem que acompanhar mais de perto a rotina de estudos deles, pais e mães perceberam\na necessidade de estarem mais próximos e inteirados  do material didático, das metodologias\nadotadas e dos professores.\nEsse processo tem seus desgastes para ambos os lado s. Os familiares e responsáveis se vêem\nsobrecarregados com essa nova demanda combinada ao trabalho no formato home office e\nafazeres do lar, mas passam a valorizar mais os pro fessores e a escola. Do outro lado, as\ninstituições de ensino passam a ser mais cobradas p or pais e mães agora com melhor\nentendimento da aprendizagem dos estudantes.\nApesar de alguns entraves, o balanço dessa quarente na pode e deve ser positivo. No fim, todos\nquerem e estão buscando o melhor ensino para as cri anças e os jovens, portanto precisamos\nestabelecer relacionamentos respeitosos, transparentes e objetivos.\nInacessibilidade a tecnologias educacionais\nOutro problema que no fundo todos temos ciência, ma s que foi escancarado pela pandemia do\nCoronavírus na Educação, é a desigualdade social e de acesso a tecnologias, o que na área da\nEducação causa um abismo entre aqueles que podem da r continuidade ao seu processo de\naprendizagem e outros que sequer possuem um disposi tivo eletrônico com conexão à internet\n\ndentro de casa.\nAs tecnologias educacionais são a principal solução  para a situação que vivemos e de maior\npotencial de inovação na maneira como ensinamos cri anças e jovens. Contudo, a realidade\nbrasileira está bem longe de ser igualitária, infelizmente.\nSegundo pesquisa do IBGE, apenas 57% da população do nosso país possui um computador em\ncondições de executar softwares mais recentes. Outr o estudo realizado em 2018, a Pesquisa TIC\nDomicílio, aponta que mais de 30% dos lares no Bras il não possuem acesso à internet, que é\npraticamente indispensável para o serviço de ensino remoto.\nO resultado disso é uma inevitável acentuação da de sigualdade de acesso não só ao ensino de\nqualidade, mas do ensino básico, causando um déficit  de aprendizagem ainda maior do que já\ntemos entre alunos do sistema público e da rede particular.\nDisponível em: sae.digital/educação-e-coronavirus/",
    "statement": "Assinale, a seguir, a alternativa em que o trecho do texto apresenta um agente da passiva.",
    "options": [
      {
        "letter": "A",
        "text": "“A maioria das escolas não conta com o suporte necessário para o oferecimento do\nensino remoto ou a distância.”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (A) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "B",
        "text": "“Inúmeros setores estão sofrendo para se adaptar e encontrar formas de superar essa\nsituação atribulada.”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (B) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "C",
        "text": "“(...) a pandemia da COVID-19 já impactou os estudos de mais de 1,5 bilhão de estudantes\nem 188 países (...)”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (C) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "D",
        "text": "“(...) o zelo que devemos ter com o ensino, que desta vez foi escancarado pela relação\nindireta entre Educação e Coronavírus.”",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial D): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      },
      {
        "letter": "E",
        "text": "“Esse cenário com milhares de escolas fechadas em diversos países não se repetia desde\na Segunda Guerra Mundial (...)”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (E) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      }
    ],
  ...
  },
  {
    ...
    "listTitle": "PDF 7 • Verbos (Aprofundamento & Concursos)",
    "questionNumber": 48,
    "readingText": "Texto II\nLIVROS-REFÚGIO: UM CONVITE A SER\nCarolina Walliter\nDas poucas lembranças nítidas que tenho da minha in fância, uma delas é a estante de livros daqui\n\nde casa, repleta de lombadas coloridas que tentam s e manter enfileiradas, até que um ou outro\ntítulo rebelde se desgarra, jogado em cima dos outros ou en&ado forçosamente entre um “tijolaço”\ne outro. Eu mal sabia ler e já me hipnotizava por e ssa visão, como se pudesse ouvir o burburinho\ndos títulos, me chamando para conhecer suas histórias.\nEssa recordação sempre aqueceu meu coração e me é de&nidora: eu sou uma pessoa de livros,\nsempre fui e serei. Pois vejo neles meu meio genuíno de me expressar para o mundo e conhecê-lo\nmelhor: a escrita. Não vou mentir, sempre achei ess a coisa de “gostar de ler” um baita elogio e\nfonte de orgulho próprio, mas não somente pelos mot ivos que vocês estão pensando – pagar de\ninteligente (porque né, quem nunca?!) –, mas por ou tros, muito mais especiais. Porque, na boa,\nlivros são e vão muito além de um símbolo socialmente construído de intelecto.\n A primeira coisa que aprendi que livros podem ser é refúgio. Na adolescência, eu me envolvi\nmuito com os livros do Harry Potter: cresci com os personagens, frequentei as aulas de Hogwarts,\nvibrei com as partidas de quadribol (nível “pulando na cama enquanto lê e comemora”). Através da\nHermione Granger, eu construí minha identidade infa nto-juvenil, aprendi a entender melhor minha\nrelação com meus melhores amigos e com meus nem tão  amigos. Eu realmente encarava a leitura\nda série como usar um par de óculos mágico que me p ermitisse enxergar melhor a minha própria\nrealidade adolescente e ficar mais em paz, menos con fusa, mais con&ante. Pegar nos livros,\ncheirar as páginas me fazia sentir protegida, compreendida e no meu lugar.\nDo livro-refúgio, logo em seguida descobri que o li vro é casa. É aquele cantinho aconchegante\nque a sua mente pode repousar e simplesmente ser do  jeito que ela é, com todas as suas dúvidas,\nmedos e receios, sem travas e filtros. E por permiti rem tamanho conforto, senti que os livros\ntambém são catarse: ler é concordar ou discordar ag ressivamente, refletir, ponderar, se\ntransformar, perceber que mudou de ideia, ficar inse gura por ter mudado de ideia, mas se\nacostumar com essa\nnova linha de raciocínio conforme a história “assenta” em você.\nE nessa coisa de me revoltar em leituras silenciosas (ou barulhentas, já que eu sempre gostei de ler\nem voz alta), me dei conta de que os livros também são o buraco na fechadura, onde\nbisbilhotamos, curiosas, o que passa no mundo do au tor, como ele enxerga a própria realidade,\nseja ela distante ou próxima a nossa. Mas eles tamb ém são espelhos, inteiros ou rachados,\ndepende de quem e quando os lê. Eles refletem e traz em à tona muito do que somos, do que\nqueremos ser e\ndo que negamos ser, consciente ou inconscientemente.\nEu fui me apercebendo dessas coisas todas que os li vros são em uma onda de autoconhecimento,\nsabe? E talvez o que livros sejam, mais que tudo, é encontro. Seu consigo, teu com outros. E é por\nisso tudo que nós acabamos cultivando relações ínti mas com eles: algumas de nós os deixamos\nintocáveis, não queremos nem abri-los muito para nã o perderem o viço de novos. Porém, em um\n\nlampejo de mudança, decidimos usar e abusar daquelas páginas, rabiscando, desenhando,\ndestacando passagens, como se fossem recados ao nos so futuro eu, que daqui a alguns anos, se\nreencontrará naquelas páginas.\nEu gosto mesmo é do livro que deixa claro para o mu ndo que é rodado, sabe? É o livro que mais\nencerra histórias, não apenas aquela impressa em su as páginas, mas aquelas de seus leitores,\nacumuladas em pontinhas de páginas dobradas, mancha s de café, borrões de lágrimas. É o livro\nque ultrapassou seu mero propósito de entreter e convidou o leitor a ser.\n(Disponível em <http:/ /www.revistacapitolina.com.br/livros-refugio-um-convite-a-ser/> Acesso e\n24 abr. 2021)\nLeia: “Porém, em um lampejo de mudança, decidimos u sar e abusar daquelas páginas, rabiscando,\ndesenhando, destacando passagens, como se fossem re cados ao nosso futuro eu, que daqui a\nalguns anos, se reencontrará naquelas páginas”",
  ...
  },
  {
    ...
    "listTitle": "PDF 7 • Verbos (Aprofundamento & Concursos)",
    "questionNumber": 49,
    "readingText": "Texto I\nO primeiro livro de cada uma das minhas vidas\nClarice Lispector\nPerguntaram-me uma vez qual fora o primeiro livro de minha vida. Pre&ro falar do primeiro livro de\ncada uma das minhas vidas. Busco na memória e tenho  a sensação quase física nas mãos ao\nsegurar aquela preciosidade: um livro fininho que co ntava a história do patinho feio e da lâmpada\nde Aladim. Eu lia e relia as duas histórias, crianç a não tem disso de só ler uma vez: criança quase\naprende de cor e, mesmo quase sabendo de cor, relê com muito da excitação da primeira vez. A\nhistória do patinho que era feio no meio dos outros  bonitos, mas quando cresceu revelou o\n\nmistério: ele não era pato e sim um belo cisne. Ess a história me fez meditar muito, e identifiquei-\nme com o sofrimento do patinho feio – quem sabe se eu era um cisne?\nQuanto a Aladim, soltava minha imaginação para as l onjuras do impossível a que eu era crédula: o\nimpossível naquela época estava ao meu alcance. A i deia do gênio que dizia: pede de mim o que\nquiseres, sou teu servo – isso me fazia cair em dev aneio. Quieta no meu canto, eu pensava se\nalgum dia um gênio me diria: “Pede de mim o que quiseres.” Mas desde então revelava-se que sou\ndaqueles que têm que usar os próprios recursos para  terem o que querem, quando conseguem.\nTive várias vidas. Em outra de minhas vidas, o meu livro sagrado foi emprestado porque era muito\ncaro: Reinações de Narizinho. Já contei o sacrifíci o de humilhações e perseveranças pelo qual\npassei, pois, já pronta para ler Monteiro Lobato, o  livro grosso pertencia a uma menina cujo pai\ntinha uma livraria. A menina gorda e muito sardenta  se vingara tornando-se sádica e, ao descobrir\no que valeria para mim ler aquele livro, fez um jog o de “amanhã venha em casa que eu empresto”.\nQuando eu ia, com o coração literalmente batendo de  alegria, ela me dizia: “Hoje não posso\nemprestar, venha amanhã.” Depois de cerca de um mês de venha amanhã, o que eu, embora altiva\nque era, recebia com humildade para que a menina nã o me cortasse de vez a esperança, a mãe\ndaquele primeiro monstrinho de minha vida notou o q ue se passava e, um pouco horrorizada com\na própria filha, deu-lhe ordens para que naquele mes mo momento me fosse emprestado o livro.\nNão o li de uma vez: li aos poucos, algumas páginas  de cada vez para não gastar. Acho que foi o\nlivro que me deu mais alegria naquela vida.\nEm outra vida que tive, eu era sócia de uma bibliot eca popular de aluguel. Sem guia, escolhia os\nlivros pelo título. E eis que escolhi um dia um liv ro chamado O lobo da estepe, de Herman Hesse.\nO título me agradou, pensei tratar-se de um livro de aventuras tipo Jack London. O livro, que li\ncada vez mais deslumbrada, era de aventura sim, mas  outras aventuras. E eu, que já escrevia\npequenos contos, dos 13 aos 14 anos fui germinada p or Herman Hesse e comecei a escrever um\nlongo conto imitando-o: a viagem interior me fascin ava. Eu havia entrado em contato com a\ngrande literatura.\nEm outra vida que tive, aos 15 anos, com o primeiro  dinheiro ganho por trabalho meu, entrei altiva\nporque tinha dinheiro, numa livraria, que me parece u o mundo onde eu gostaria de morar. Folheei\nquase todos os livros dos balcões, lia algumas linh as e passava para outro. E de repente, um dos\nlivros que abri continha frases tão diferentes que fiquei lendo, presa, ali mesmo. Emocionada, eu\npensava: mas esse livro sou eu! E, contendo um estr emecimento de profunda emoção, comprei-o.\nSó então vim a saber que a autora não era anônima, sendo, ao contrário, considerada um dos\nmelhores escritores de sua época: Katherine Mansfield.\n(Disponível em <https:/ /contobrasileiro.com.br/o-primeiro-livro-de-cada-uma-das-minhas-vidas-\nclarice-lispector/> Acesso em 24 abr. 2021)",
  ...
  },
  {
    ...
    "listTitle": "PDF 7 • Verbos (Aprofundamento & Concursos)",
    "questionNumber": 50,
    "readingText": "Texto I\nO primeiro livro de cada uma das minhas vidas\nClarice Lispector\nPerguntaram-me uma vez qual fora o primeiro livro de minha vida. Pre&ro falar do primeiro livro de\ncada uma das minhas vidas. Busco na memória e tenho  a sensação quase física nas mãos ao\nsegurar aquela preciosidade: um livro fininho que co ntava a história do patinho feio e da lâmpada\nde Aladim. Eu lia e relia as duas histórias, crianç a não tem disso de só ler uma vez: criança quase\naprende de cor e, mesmo quase sabendo de cor, relê com muito da excitação da primeira vez. A\nhistória do patinho que era feio no meio dos outros  bonitos, mas quando cresceu revelou o\nmistério: ele não era pato e sim um belo cisne. Ess a história me fez meditar muito, e identifiquei-\nme com o sofrimento do patinho feio – quem sabe se eu era um cisne?\nQuanto a Aladim, soltava minha imaginação para as l onjuras do impossível a que eu era crédula: o\nimpossível naquela época estava ao meu alcance. A i deia do gênio que dizia: pede de mim o que\nquiseres, sou teu servo – isso me fazia cair em dev aneio. Quieta no meu canto, eu pensava se\nalgum dia um gênio me diria: “Pede de mim o que quiseres.” Mas desde então revelava-se que sou\ndaqueles que têm que usar os próprios recursos para  terem o que querem, quando conseguem.\nTive várias vidas. Em outra de minhas vidas, o meu livro sagrado foi emprestado porque era muito\ncaro: Reinações de Narizinho. Já contei o sacrifíci o de humilhações e perseveranças pelo qual\npassei, pois, já pronta para ler Monteiro Lobato, o  livro grosso pertencia a uma menina cujo pai\ntinha uma livraria. A menina gorda e muito sardenta  se vingara tornando-se sádica e, ao descobrir\no que valeria para mim ler aquele livro, fez um jog o de “amanhã venha em casa que eu empresto”.\nQuando eu ia, com o coração literalmente batendo de  alegria, ela me dizia: “Hoje não posso\nemprestar, venha amanhã.” Depois de cerca de um mês de venha amanhã, o que eu, embora altiva\nque era, recebia com humildade para que a menina nã o me cortasse de vez a esperança, a mãe\ndaquele primeiro monstrinho de minha vida notou o q ue se passava e, um pouco horrorizada com\na própria filha, deu-lhe ordens para que naquele mes mo momento me fosse emprestado o livro.\n\nNão o li de uma vez: li aos poucos, algumas páginas  de cada vez para não gastar. Acho que foi o\nlivro que me deu mais alegria naquela vida.\nEm outra vida que tive, eu era sócia de uma bibliot eca popular de aluguel. Sem guia, escolhia os\nlivros pelo título. E eis que escolhi um dia um liv ro chamado O lobo da estepe, de Herman Hesse.\nO título me agradou, pensei tratar-se de um livro de aventuras tipo Jack London. O livro, que li\ncada vez mais deslumbrada, era de aventura sim, mas  outras aventuras. E eu, que já escrevia\npequenos contos, dos 13 aos 14 anos fui germinada p or Herman Hesse e comecei a escrever um\nlongo conto imitando-o: a viagem interior me fascin ava. Eu havia entrado em contato com a\ngrande literatura.\nEm outra vida que tive, aos 15 anos, com o primeiro  dinheiro ganho por trabalho meu, entrei altiva\nporque tinha dinheiro, numa livraria, que me parece u o mundo onde eu gostaria de morar. Folheei\nquase todos os livros dos balcões, lia algumas linh as e passava para outro. E de repente, um dos\nlivros que abri continha frases tão diferentes que fiquei lendo, presa, ali mesmo. Emocionada, eu\npensava: mas esse livro sou eu! E, contendo um estr emecimento de profunda emoção, comprei-o.\nSó então vim a saber que a autora não era anônima, sendo, ao contrário, considerada um dos\nmelhores escritores de sua época: Katherine Mansfield.\n(Disponível em <https:/ /contobrasileiro.com.br/o-primeiro-livro-de-cada-uma-das-minhas-vidas-\nclarice-lispector/> Acesso em 24 abr. 2021)\nLeia: “E eu, que já escrevia pequenos contos, dos 1 3 aos 14 anos fui germinada por Herman Hesse\ne comecei a escrever um longo conto imitando-o: a viagem interior me fascinava.”",
    "statement": "A construção verbal em destaque, se escrita na voz ativa, poderia ser substituída por um sinônimo,\nprovocaria a seguinte reescrita:",
    "options": [
      {
        "letter": "A",
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "letter": "D",
        "text": "“Não discutimos, não queixamos e muitas vezes caminhamos juntos através de portas\nabertas.”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (D) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "E",
        "text": "“Quando você a lamenta, você está dizendo que gostaria de se livrar dela, que ela é um\nsofrimento, uma doença, uma inimiga...”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (E) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      }
    ],
  ...
  },
  {
    ...
    "listTitle": "PDF 7 • Verbos (Aprofundamento & Concursos)",
    "questionNumber": 55,
    "readingText": "A solidão amiga\nA noite chegou, o trabalho acabou, é hora de voltar  para casa. Lar, doce lar? Mas a casa está\nescura, a televisão apagada e tudo é silêncio. Ning uém para abrir a porta, ninguém à espera. Você\nestá só. Vem a tristeza da solidão... O que mais você deseja é não estar em solidão...\nMas deixa que eu lhe diga: sua tristeza não vem da solidão. Vem das fantasias que surgem na\nsolidão. Lembro-me de um jovem que amava a solidão:  ficar sozinho, ler, ouvir, música... Assim,\n\naos sábados, ele se preparava para uma noite de sol idão feliz. Mas bastava que ele se assentasse\npara que as fantasias surgissem. Cenas. De um lado,  amigos em festas felizes, em meio ao\nfalatório, os risos, a cervejinha. Aí a cena se alt erava: ele, sozinho naquela sala. Com certeza\nninguém estava se lembrando dele. Naquela festa fel iz, quem se lembraria dele? E aí a tristeza\nentrava e ele não mais podia curtir a sua amiga sol idão. O remédio era sair, encontrar-se com a\nturma para encontrar a alegria da festa. Vestia-se,  saía, ia para a festa... Mas na festa ele percebia\nque festas reais não são iguais às festas imaginada s. Era um desencontro, uma impossibilidade de\ncompartilhar as coisas da sua solidão... A noite estava perdida.\nFaço-lhe uma sugestão: leia o livr o A chama de uma vela, de Bachelard . É um dos livros mais\nsolitários e mais bonitos que jamais li. A chama de  uma vela, por oposição às luzes das lâmpadas\nelétricas, é sempre solitária. A chama de uma vela cria, ao seu redor, um círculo de claridade\nmansa que se perde nas sombras. Bachelard medita di ante da chama solitária de uma vela. Ao seu\nredor, as sombras e o silêncio. Nenhum falatório bobo ou riso fácil para perturbar a verdade da sua\nalma. Lendo o livro solitário de Bachelard eu encon trei comunhão. Sempre encontro comunhão\nquando o leio. As grandes comunhões não acontecem em meio aos risos da festa. Elas\nacontecem, paradoxalmente, na ausência do outro. Qu em ama sabe disso. É precisamente na\nausência que a proximidade é maior. Bachelard, ause nte: eu o abracei agradecido por ele assim\nme entender tão bem. Como ele observa, \"parece que há em nós cantos sombrios que toleram\napenas uma luz bruxoleante. Um coração sensível gos ta de valores frágeis\". A vela solitária de\nBachelard iluminou meus cantos sombrios, fez-me ver  os objetos que se escondem quando há\nmais gente na cena. E ele faz uma pergunta que julg o fundamental e que proponho a você, como\nmotivo de meditação: \"Como se comporta a Sua Solidã o?\" Minha solidão? Há uma solidão que é\nminha, diferente das solidões dos outros? A solidão se comporta? Se a minha solidão se comporta,\nela não é apenas uma realidade bruta e morta. Ela tem vida.\nEntre as muitas coisas profundas que Sartre disse, essa é a que mais amo: \"Não importa o que\nfizeram com você. O que importa é o que você faz com  aquilo que fizeram com você.\" Pare. Leia\nde novo. E pense. Você lamenta essa maldade que a v ida está fazendo com você, a solidão. Se\nSartre está certo, essa maldade pode ser o lugar onde você vai plantar o seu jardim. \nComo é que a sua solidão se comporta? Ou, talvez, d ando um giro na pergunta: Como você se\ncomporta com a sua solidão? O que é que você está f azendo com a sua solidão? Quando você a\nlamenta, você está dizendo que gostaria de se livra r dela, que ela é um sofrimento, uma doença,\numa inimiga... Aprenda isso: as coisas são os nomes  que lhe damos. Se chamo minha solidão de\ninimiga, ela será minha inimiga. Mas será possível chamá la de amiga? Drummond acha que sim:\n\"Por muito tempo achei que a ausência é falta./ E l astimava, ignorante, a falta./ Hoje não a\nlastimo./ Não há falta na ausência. A ausência é um  estar em mim./ E sinto-a, branca, tão pegada,\naconchegada nos meus braços,/ que rio e danço e inv ento exclamações alegres,/ porque a\nausência, essa ausência assimilada,/ ninguém a rouba mais de mim.!\" \n\nNietzsche também tinha a solidão como sua companhei ra. Sozinho, doente, tinha enxaquecas\nterríveis que duravam três dias e o deixavam cego. Ele tirava suas alegrias de longas caminhadas\npelas montanhas, da música e de uns poucos livros q ue ele amava. Eis aí três companheiras\nmaravilhosas! Vejo, frequentemente, pessoas que cam inham por razões da saúde. Incapazes de\ncaminhar sozinhas, vão aos pares, aos bandos. E vão  falando, falando, sem ver o mundo\nmaravilhoso que as cerca. Falam porque não suportar iam caminhar sozinhas. E, por isso mesmo,\nperdem a maior alegria das caminhadas, que é a aleg ria de estar em comunhão com a natureza.\nElas não veem as árvores, nem as flores, nem as nuve ns e nem sentem o vento. Que troca infeliz!\nTrocam as vozes do silêncio pelo falatório vulgar. Se estivessem a sós com a natureza, em silêncio,\nsua solidão tornaria possível que elas ouvissem o q ue a natureza tem a dizer. O estar juntos não\nquer dizer comunhão. O estar juntos, frequentemente, é uma forma terrível de solidão, um artifício\npara evitar o contato conosco mesmos. Sartre chegou ao ponto de dizer que \"o inferno é o outro.\"\nSobre isso, quem sabe, conversaremos outro dia... M as, voltando a Nietzsche, eis o que ele\nescreveu sobre a sua solidão: \"Ó solidão! Solidão, meu lar!... Tua voz – ela me fala com ternura e\nfelicidade!” \nNão discutimos, não queixamos e muitas vezes caminhamos juntos através de portas abertas. \nPois onde quer que estás, ali as coisas são abertas  e luminosas. E até mesmo as horas caminham\ncom pés saltitantes.\nAli as palavras e os tempos/poemas de todo o ser se  abrem diante de mim. Ali todo ser deseja\ntransformar se em palavra, e toda mudança pede para aprender de mim a falar.\nRubem Alves. Disponível em: www.pensador.com/crônic as_de_rubem_alves/. Acessado em\n10/03/2021.",
    "statement": "No penúltimo parágrafo do texto, o autor escolhe a forma “estás” em lugar de “estejas”, que\natenderia à norma culta. Essa escolha, no âmbito do texto, justifica-se porque o autor",
    "options": [
      {
        "letter": "A",
  ...
  },
  {
    ...
    "listTitle": "PDF 7 • Verbos (Aprofundamento & Concursos)",
    "questionNumber": 56,
    "readingText": "Texto I\n\nFigura o anúncio em um jornal que o amigo me mandou, e está assim redigido:\nÀ procura de uma besta . – A partir de 6 de outubro do ano cadente, sumiu- me uma besta\nvermelho-escura com os seguintes característicos: c alçada e ferrada de todos os membros\nlocomotores, um pequeno quisto na base da orelha di reita e crina dividida em duas seções em\nconsequência de um golpe, cuja extensão pode alcanç ar de quatro a seis centímetros, produzido\npor jumento.\nEssa besta, muito domiciliada nas cercanias deste c omércio, é muito mansa e boa de sela, e tudo\nme induz ao cálculo de que foi roubada, assim que hão sido falhas todas as indagações.\nQuem, pois, apreendê-la em qualquer parte e a fizer entregue aqui ou pelo menos notícia exata\nministrar, será razoavelmente remunerado. Itambé do  Mato Dentro, 19 de novembro de 1899. (a)\nJoão Alves Júnior.\nCinquenta e cinco anos depois, prezado João Alves J únior, tua besta vermelho-escura, mesmo\nque tenha aparecido, já é pó no pó. E tu mesmo, se não estou enganado, repousas suavemente no\npequeno cemitério de Itambé. Mas teu anúncio contin ua um modelo no gênero, se não para ser\nimitado, ao menos como objeto de admiração literária.\nReparo antes de tudo na limpeza de tua linguagem. N ão escreveste apressada e toscamente,\ncomo seria de esperar de tua condição rural. Pressa , não a tiveste, pois o animal desapareceu a 6\nde outubro, e só a 19 de novembro recorreste à Cidade de Itabira . Antes, procedeste a\nindagações. Falharam. Formulaste depois um raciocín io: houve roubo. Só então pegaste da pena,\ne traçaste um belo e nítido retrato da besta.\nNão disseste que todos os seus cascos estavam ferra dos; preferiste dizê-lo “de todos os seus\nmembros locomotores”. Nem esqueceste esse pequeno q uisto na orelha e essa divisão da crina\nem duas seções, que teu zelo naturalista e histórico atribuiu com segurança a um jumento.\nPor ser “muito domiciliada nas cercanias deste comé rcio”, isto é, do povoado e sua feirinha\nsemanal, inferiste que não teria fugido, mas antes foi roubada. Contudo, não o a&rmas em tom\nperemptório: “tudo me induz a esse cálculo”. Revela s aí a prudência mineira, que não avança (ou\nnão avançava) aquilo que não seja a evidência mesma . É cálculo, raciocínio, operação mental e\ndesapaixonada como qualquer outra, e não denúncia formal.\nFinalmente – deixando de lado outras excelências de  tua prosa útil – a declaração final: quem a\napreender ou pelo menos “notícia exata ministrar”, será “razoavelmente remunerado”. Não\nprometes recompensa tentadora; não fazes praça de g enerosidade ou largueza; acenas com o\n\nrazoável, com a justa medida das coisas, que deve p revalecer mesmo no caso de bestas perdidas\ne entregues.\nJá é muito tarde para sairmos à procura de tua best a, meu caro João Alves do Itambé; entretanto\nessa criação volta a existir, porque soubeste descr evê-la com decoro e propriedade, num dia\nremoto, e o jornal a guardou e alguém hoje a descob re, e muitos outros são informados da\nocorrência. Se lesses os anúncios de objetos e anim ais perdidos, na imprensa de hoje, ficarias\ntriste. Já não há essa precisão de termos e essa gr aça no dizer, nem essa moderação nem essa\natitude crítica. Não há, sobretudo, esse amor à tarefa bem-feita, que se pode manifestar até\nmesmo num anúncio de besta sumida.\n(Carlos Drummond de Andrade. Fala, amendoeira, 2012.)",
  ...
  },
  {
    ...
    "listTitle": "PDF 7 • Verbos (Aprofundamento & Concursos)",
    "questionNumber": 58,
    "readingText": "Crianças precisam de educação física, mesmo fora da escola\n\nFalta de atividades estruturadas, seja por causa do  isolamento social ou das férias, contribuem\npara o sedentarismo\nCollin A. Webste, traduzido por Nexo\nQuando notei que meu filho de 12 anos passava cerca de sete horas por dia fazendo seus deveres\nescolares online devido à pandemia da covid-19, me preocupei de imediato. Como pesquisador\ncom foco em ‘como tornar as crianças mais ativas &s icamente’, eu sabia que meu filho e seus\ncolegas de classe estavam sedentários por muito tempo.\nSer &sicamente ativo é bom para a saúde física e me ntal de todos, incluindo crianças de todas as\nidades e habilidades.\nCrianças mais ativas &sicamente tendem a obter nota s melhores e a desenvolver a autoconfiança\nque poderá capacitá-las a ter sucesso mais tarde em suas vidas.\nNo caso de pessoas com de&ciências, a atividade fís ica pode ajudá-las a obter certa\nindependência.\nA chegada das férias de verão (no hemisfério norte)  diminui um pouco as preocupações dos pais\nsobre os filhos estarem sedentários demais. Lembro d as férias de verão como uma pausa bem-\nvinda ao hábito de ficar sentado o dia inteiro na es cola e estar con&nado a um ambiente fechado.\nNo entanto, o inverso pode acabar sendo verdadeiro para muitas crianças atualmente.\nNos EUA, um estudo com 18.170 crianças pequenas mos trou que a parcela das que são obesas\naumenta de 8,9% para 11,5% entre o jardim de infânc ia e a segunda série. Este aumento em geral\nocorre durante o verão, e não quando as crianças estão na escola.\nPesquisadores acham que a falta de atividades estru turadas no verão pode levar crianças a\nfazerem escolhas pouco saudáveis. Essa ideia é refo rçada por uma publicação de 37 estudos\nrevelando que crianças são menos ativas nos finais de semana do que nos dias de aulas escolares.\nPesquisas também apontam que as crianças passam mai s tempo em frente às telas no verão do\nque durante o ano letivo.\nO Departamento de Saúde e Serviços Humanos american o recomenda que crianças e\nadolescentes passem pelo menos uma hora por dia cor rendo, andando de bicicleta ou fazendo\nqualquer atividade física. No entanto, de acordo co m o Centro de Controle e Prevenção de\nDoenças (CDC), apenas uma em cada quatro crianças e ntre 6 e 17 anos estava cumprindo essa\nrecomendação antes da pandemia.\nMesmo crianças que participam de esportes organizad os podem não estar atingindo os 60\n\nminutos de atividade por dia prescritos. Um estudo descobriu que crianças em ligas de futebol-\nbandeira (uma variação menos violenta do futebol am ericano) passavam apenas 20 minutos se\nexercitando durante os treinos em equipe. Essa desc oberta é bastante consistente em outros\nesportes também, como futebol e basquete, onde não mais da metade do tempo de treino era\ndedicada à prática de exercícios físicos.\nO nível de atividade física despenca quando as cria nças chegam ao ensino fundamental, não\nfazendo muita diferença se elas estão em equipes co mpetitivas ou não. Um estudo em San Diego\ndescobriu que crianças entre 11 e 14 anos gastam um  total de sete minutos a menos em atividade\nfísica, do que crianças entre 7 e 10 anos, durante práticas esportivas.\nAinda assim, crianças e adolescentes gastam em torn o de oito horas por dia em ocupações como\nassistir a TV, usar smartphones e jogar videogame.(...)\nNo geral, a maioria dos sistemas escolares não estava fazendo o suficiente para manter as crianças\nem forma antes da covid-19 dar início a meses de ap rendizado remoto improvisado. O CDC deu\nàs escolas uma nota D- por seus esforços nessa frente.\nEm resumo, a grande maioria das crianças precisa ga star mais tempo sendo ativa tanto na escola\nquanto em casa. O tempo adicional gasto nas aulas de educação física aumenta a capacidade dos\nalunos de aprender as habilidades para se manterem ativos quando adultos.\nA educação física oferece às crianças mais do que a penas exercícios, e é por isso que atividades\ncomo banda marcial e até esportes coletivos são, na  minha opinião, um substituto ruim para a\ndisciplina.\nNo ensino infantil, a educação física deveria apoia r principalmente o desenvolvimento de\nhabilidades motoras fundamentais, como pular, chuta r, arremessar e receber, que são essenciais\npara uma grande variedade de atividades, como a mai oria dos esportes coletivos, dança e\nginástica. Crianças que dominarem essas habilidades  quando pequenas serão mais ativas\nfisicamente do que aquelas que não.\nOs programas de educação física dos ensinos fundame ntal e médio deveriam focar em manter as\ncrianças motivadas a permanecerem ativas. Como os a dolescentes são mais motivados a serem\n&sicamente ativos quando sentem que estão no contro le de seu aprendizado, é preciso dar-lhes\nautonomia para escolher o que fazer. Como crianças diferentes têm interesses diferentes, o\ncurrículo de educação física deveria abranger não a penas esportes coletivos, mas também\natividades que demandam menos participantes, como tênis e golfe.\nEstudantes de todos os níveis de ensino deveriam te r oportunidades para desenvolver suas\n\naptidões físicas, especialmente sua resistência aeróbica, força muscular e flexibilidade.\n(...)\nNunca esqueça disso: a atividade física é um hábito  e a forma física é uma condição (adquirida\ncomo consequência). Nenhum dos dois é sinônimo de e ducação física, mas um bom programa\najudará a promover ambos. Collin A. Webster é reito r da Faculdade de Educação Associada para\nPesquisa e Inovação e professor de educação física da Universidade da Carolina do Sul\n(Disponível em < https:/ /www.nexojornal.com.br/exte rno/2020/06/05/Crian%C3%A7as-\nprecisam-de-educa%C3%A7%C3%A3o-f%C3%ADsica-mesmo-fora-da-escola> Acesso em 09\njun. 2021)",
    "statement": "Assinale a opção em que se encontra uma oração na voz passiva.",
    "options": [
      {
        "letter": "A",
        "text": "Essa ideia é reforçada por uma publicação de 37 estudos revelando que crianças são\nmenos ativas nos finais de semana do que nos dias de aulas escolares.",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial A): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      },
      {
        "letter": "B",
        "text": "Mesmo crianças que participam de esportes organizados podem não estar atingindo os\n60 minutos de atividade por dia prescritos.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (B) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "C",
        "text": "Um estudo descobriu que crianças em ligas de futebol-bandeira (uma variação menos\nviolenta do futebol americano) passavam apenas 20 minutos se exercitando durante os\ntreinos em equipe.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (C) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "D",
        "text": "O tempo adicional gasto nas aulas de educação física aumenta a capacidade dos alunos\nde aprender as habilidades para se manterem ativos quando adultos.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (D) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
  ...
  },
  {
    ...
    "questionNumber": 59,
    "readingText": "",
    "statement": "Assinale, a seguir, o enunciado em que o verbo “hav er” poderia sofrer concordância de número\ncom o sujeito.",
    "options": [
      {
        "letter": "A",
  ...
  },
  {
    ...
    "questionNumber": 60,
    "readingText": "",
    "statement": "A transposição da voz passiva para a ativa em “E as  notícias foram agrupadas em cinco grandes\ncategorias: negócios e dinheiro, saúde, ciência e t ecnologia, esportes e mundo” está correta na\nalternativa:",
    "options": [
      {
        "letter": "A",
        "text": "Agrupou as notícias em cinco grandes categorias: negócios e dinheiro, saúde, ciência e\ntecnologia, esportes e mundo.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (A) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "B",
        "text": "Agrupou-se, em cinco grandes categorias, as notícias: negócios e dinheiro, saúde, ciência\ne tecnologia, esportes e mundo.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (B) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "C",
        "text": "As notícias agruparam-se em cinco grandes categorias: negócios e dinheiro, saúde,\nciência e tecnologia, esportes e mundo.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (C) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "D",
        "text": "Agruparam-se as notícias em cinco grandes categorias: negócios e dinheiro, saúde,\nciência e tecnologia, esportes e mundo.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (D) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "E",
        "text": "Agruparam as notícias em cinco grandes categorias: negócios e dinheiro, saúde, ciência e\ntecnologia, esportes e mundo.",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial E): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      }
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "letter": "B",
        "text": "O dono da casa, lembrando-se da dupla necessidade de fazer esporadicamente algum\nesporte e de almoçar (...)",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (B) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
  ...
  },
  {
    ...
    "listTitle": "PDF 7 • Verbos (Aprofundamento & Concursos)",
    "questionNumber": 62,
    "readingText": "TEXTO 2\nO que explica nosso fascínio com Frankenstein, 200 anos após sua criação?\nLucy Todd, BBC\n3 janeiro 2018\n\nOs &lmes de terror estabeleceram a ideia de Franken stein como a história de um monstro\nassassino e irracional criado pelo homem. Mas a criação de Shelley era bem diferente.\nShelley lida com os mesmos temas tratados pelos gre gos”, diz Patricia MacCormack, professora\nde Filoso&a da Universidade Anglia Ruskin, no Reino  Unido, e autora de estudos sobre obras de\nterror.\n“As boas versões cinematográficas trazem a mesma vis ão crítica sobre a vida, a nossa busca por\npropósito e os papéis que desempenhamos. O monstro não escolheu existir e questiona sua\nprópria existência: ‘Como me torno uma boa pessoa?’”\nNa obra original, o cientista Victor Frankenstein d á vida a uma criatura com nuances, sensível e\ncuriosa. MacCormack diz que o monstro lida com as m ais fundamentais questões humanas: “É a\nideia de perguntar ao seu criador qual é seu propós ito. Por que estamos aqui? O que podemos\nfazer?”. (...)\nO romance de Shelley contém elementos fantásticos e  de horror, e é a combinação deles que\ntornam a história um sucesso.\n“Ele nos fascina porque fala da relação entre vida e morte”, diz Sorcha Ni Fhlainn, palestrante de\nEstudos de Cinema da Universidade Metropolitana de Manchester, no Reino Unido, e integrante\ndo Centro de Estudos Góticos de Manchester.\n“A morte é absoluta. Então, a ideia de que você pod e reanimar a carne é ao mesmo tempo\nchocante e arrebatadora.”\n(Disponível em: <https://www.bbc.com/portuguese/geral42537245> Acesso em 26 mai. 2020)",
    "statement": "O trecho “Na obra original, o cientista Victor Fran kenstein dá vida a uma criatura com nuances,\nsensível e curiosa” pode ser inteiramente reescrito, na voz passiva, em",
    "options": [
      {
        "letter": "A",
        "text": "Na obra original, dá-se vida a uma criatura com nuances, sensível e curiosa, pelo cientista\nVictor Frankenstein.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (A) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "B",
        "text": "A uma criatura com nuances, sensível e curiosa é dada vida, na obra original, pelo cientista\nVictor Frankenstein.",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial B): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      },
      {
        "letter": "C",
        "text": "Ao cientista Victor Frankenstein, é dada vida a uma criatura com nuances, sensível e\ncuriosa, na obra original",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (C) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "D",
        "text": "O cientista Victor Frankenstein dá-se vida a uma criatura com nuances, sensível e curiosa,\nna obra original.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (D) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      }
    ],
  ...
  },
  {
    ...
    "listTitle": "PDF 7 • Verbos (Aprofundamento & Concursos)",
    "questionNumber": 64,
    "readingText": "Texto II\nFolia agigantada\nDiante do maior Carnaval de sua história, São Paulo precisa cuidar da organização\nSão Paulo prepara-se para ser palco do maior Carnav al de rua de sua história. Pela primeira vez, a\ncidade, que já foi apelidada de “túmulo do samba”, terá des&les em todas as suas 32\nsubprefeituras.\nTambém em número de blocos, a folia promete expansã o inédita. Os números são preliminares,\nmas as 490 agremiações do ano passado deverão ser l argamente suplantadas – o aumento\nprevisto é de 70%.\nNovas atrações também animarão a festa, como o famoso Galo da Madrugada, de Pernambuco.\nLevantamentos preliminares sugerem que a capital pa ulista poderá ser o principal destino turístico\ndo país durante os festejos, suplantando Rio de Jan eiro e Salvador. Com isso, projeta-se aumento\nda circulação de dinheiro, em favor de hotéis, bares, comércio etc.\nNo cenário animador, um certo clima de ufanismo par ece contagiar quadros da prefeitura, que\ntem em seus membros um carnavalesco conhecido – o s ecretário de Cultura, Alê Youssef,\nfundador do bloco Acadêmicos do Baixo Augusta.\n\nYoussef, que representa uma face mais progressista do governo municipal, vê no Carnaval\ntambém um meio de manifestação política – que, aliá s, se potencializa em ano eleitoral. O\nsecretário já declarou que pretende fazer com que a  festa seja um contraponto a ameaças à\nliberdade de expressão.\nA expansão do Carnaval de rua é um fenômeno que se observa há anos em diversas cidades. No\nRio, por exemplo, os blocos começaram a reconquista r as ruas a partir da primeira década do\nséculo. O retorno do que seria um tipo mais autênti co de comemoração provocou simpatias e\nelogios da população e de cronistas da festa.\nCom o tempo, contudo, a outra face do crescimento d a folia foi-se mostrando problemática – a\ninsuficiência de banheiros públicos, o aumento de fu rtos, o trânsito interrompido, as áreas\nprotegidas ocupadas por blocos não autorizados e o excesso de barulho.\nA Prefeitura de São Paulo a&rma que reestruturou o planejamento do evento com vistas a diminuir\nos transtornos. Ao longo de 37 reuniões, os trajetos passaram pelo crivo de diversos órgãos, como\nCET, SPTrans (responsável pelos ônibus), polícia e GCM (Guarda Civil Metropolitana). Medidas\nem outras áreas também foram anunciadas.\nCabe às autoridades, agora, fazer com que a propala da reorganização saia do papel e garanta à\ncidade e a seus moradores um padrão aceitável de funcionamento.\nhttps://www1.folha.uol.com.br/opiniao/2020/02/folia-agigantada.shtml?origin=folha",
    "statement": "A organização discursiva passa pela escolha adequad a dos tempos verbais. As formas verbais\n“sugerem” (4º parágrafo) e “parece” (5º parágrafo) indicam:",
    "options": [
      {
        "letter": "A",
  ...
  },
  {
    ...
    "listTitle": "PDF 7 • Verbos (Aprofundamento & Concursos)",
    "questionNumber": 65,
    "readingText": "Mulher na Marinha\nA data de 7 de julho é um dia de júbilo para a Mari nha do Brasil, com a comemoração do\n\nAniversário de Ingresso das Mulheres em suas fileira s. Como resultado da visão e do empenho do\nentão Ministro de Estado da Marinha, Almirante de E squadra Maximiano Eduardo da Silva\nFonseca, ao se alinhar aos anseios da sociedade brasileira e à crescente participação da mulher no\nmercado de trabalho, foi promulgada a Lei n° 6.807,  de 7 de julho de 1980, criando o Corpo\nAuxiliar Feminino da Reserva da Marinha (CAFRM), ma rco inicial e pioneiro da participação da\nmulher nas Forças Armadas brasileiras.\nA Lei nº 9.519, de 26 de novembro de 1997, que rees truturou os Corpos e Quadros de Oficiais e\nPraças da Marinha, além de extinguir o CAFRM, ampli ou significativamente a participação da\nmulher nas atividades da Força Naval. Em consequênc ia, outrora pertencente a um único Corpo\nAuxiliar, as Oficiais e Praças da Marinha do Brasil (MB) passaram a prestar serviços no Corpo de\nIntendentes da Marinha (IM), no Corpo de Engenheiro s da Marinha (EN), nos Quadros do Corpo\nde Saúde da Marinha, nos Quadros Técnico e Auxiliar  da Armada do Corpo Auxiliar da Marinha,\nno Corpo Auxiliar de Praças e no Quadro de Músicos do Corpo de Praças de Fuzileiros Navais.\nEm novembro de 2012, foi assinada a promoção da pri meira mulher a ocupar um cargo de O&cial\nGeneral das Forças Armadas Brasileiras, a Contra-Al mirante (Md) Dalva Maria Carvalho Mendes.\nAssim, a MB rea&rmou seu pioneirismo, pois foi tamb ém a primeira Força que admitiu mulheres\nmilitares em seus quadros.\nComo parte do contínuo processo de atualização e ap rimoramento da administração do seu\npessoal, a Força Naval admitiu, em 2014, a primeira  turma de Aspirantes femininas da Escola\nNaval.\nForam 12 vagas específicas para o Corpo de IM, desti nadas a candidatas com idade entre 18 e 23\nanos, que tivessem concluído o ensino médio.\nAlém da formação profissional-militar, as Aspirantes  recebem aulas de Educação Física e, de\nacordo com seu desempenho, podem integrar uma das v árias equipes esportivas, como: esgrima,\nvela, remo, vôlei, basquete, orientação, atletismo, judô e tiro. As futuras Oficiais poderão participar,\nainda, de diversos grêmios, como: línguas, xadrez, comunicações, aviação, mergulho, música,\nfotografia, etc.\nAo final do curso, foram declaradas Guardas-Marinha e embarcaram no Navio-Escola “Brasil”,\nonde realizaram uma viagem de instrução de duração aproximada de seis meses, durante a qual,\ncomplementaram sua formação profissional e cultural,  tendo a oportunidade de visitar países das\nAméricas, Europa, percorrendo os Oceanos Atlântico e Pacífico, e o Mar Mediterrâneo.\nApós o regresso da viagem de instrução, as Guardas-Marinha foram nomeadas Oficiais – no posto\nde 2º Tenente – e designadas para exercerem ativida des nas diversas Organizações Militares da\nMB distribuídas ao longo de todo o território nacional.\n\nPor meio do Memorando n° 1, de 10 de abril de 2017,  o então Comandante da Marinha, Almirante\nde Esquadra Eduardo Bacellar Leal Ferreira, decidiu  ampliar a participação de Oficiais e Praças\nfemininas em atividades de aplicação efetiva do Pod er Naval, autorizando o embarque em navios\ne unidades de tropa. Dessa forma, as Oficiais passar ão a ingressar nos Corpos da Armada (CA) e\nde Fuzileiros Navais (CFN), a partir da Escola Nava l, além de fazerem parte do Corpo de\nIntendentes da Marinha (CIM), opção já aceita. As Praças femininas, também, poderão fazer parte\ndo Corpo de Praças da Armada, o que permitirá o embarque em meios do Setor Operativo.\nO Edital de 2018 trouxe vagas específicas para as mu lheres. Ingressando na Escola Naval no ano\nde 2019, ao início do 3° ano letivo, elas farão a o pção de curso e habilitação, de acordo com sua\nordem de classificação obtida no segundo ano letivo.\nAo longo dos anos, a participação das mulheres foi sendo ampliada para diversas áreas de atuação,\nincluindo a Direção de importantes Organizações Mil itares. Com equilíbrio e competência, a\nmulher marinheira vem consolidando cada vez mais su a participação nos diversos Corpos e\nQuadros dos Oficiais e Praças da Marinha do Brasil, contribuindo, sobremaneira, para o\ncumprimento das mais variadas tarefas da nossa Força, com maior eficiência e eficácia.\nhttps://www.marinha.mil.br/mulher-na-marinha",
    "statement": "Marque a alternativa que apresenta predicado verbo-nominal:",
    "options": [
      {
        "letter": "A",
        "text": "“...as Aspirantes recebem aulas de Educação Física e, de acordo com seu desempenho,\npodem integrar uma das várias equipes esportivas...”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (A) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "B",
        "text": "“As futuras Oficiais poderão participar, ainda, de diversos grêmios, como: línguas, xadrez,\ncomunicações, aviação, mergulho, música, fotografia, etc.”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (B) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
      ...
      {
        "letter": "D",
        "text": "“Após o regresso da viagem de instrução, as Guardas-Marinha foram nomeadas Oficiais –\nno posto de 2º Tenente – e designadas para exercerem atividades nas diversas\nOrganizações Militares da MB.”",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial D): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      },
      {
        "letter": "E",
        "text": "“...o então Comandante da Marinha, Almirante de Esquadra Eduardo Bacellar Leal Ferreira,\ndecidiu ampliar a participação de Oficiais e Praças femininas em atividades de aplicação\nefetiva do Poder Naval.”\n4000034700",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (E) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      }
    ],
  ...
  },
  {
    ...
    "questionNumber": 67,
    "readingText": "Mulher na Marinha\nA data de 7 de julho é um dia de júbilo para a Mari nha do Brasil, com a comemoração do\nAniversário de Ingresso das Mulheres em suas fileira s. Como resultado da visão e do empenho do\nentão Ministro de Estado da Marinha, Almirante de E squadra Maximiano Eduardo da Silva\n\nFonseca, ao se alinhar aos anseios da sociedade brasileira e à crescente participação da mulher no\nmercado de trabalho, foi promulgada a Lei n° 6.807,  de 7 de julho de 1980, criando o Corpo\nAuxiliar Feminino da Reserva da Marinha (CAFRM), ma rco inicial e pioneiro da participação da\nmulher nas Forças Armadas brasileiras.\nA Lei nº 9.519, de 26 de novembro de 1997, que rees truturou os Corpos e Quadros de Oficiais e\nPraças da Marinha, além de extinguir o CAFRM, ampli ou significativamente a participação da\nmulher nas atividades da Força Naval. Em consequênc ia, outrora pertencente a um único Corpo\nAuxiliar, as Oficiais e Praças da Marinha do Brasil (MB) passaram a prestar serviços no Corpo de\nIntendentes da Marinha (IM), no Corpo de Engenheiro s da Marinha (EN), nos Quadros do Corpo\nde Saúde da Marinha, nos Quadros Técnico e Auxiliar  da Armada do Corpo Auxiliar da Marinha,\nno Corpo Auxiliar de Praças e no Quadro de Músicos do Corpo de Praças de Fuzileiros Navais.\nEm novembro de 2012, foi assinada a promoção da pri meira mulher a ocupar um cargo de O&cial\nGeneral das Forças Armadas Brasileiras, a Contra-Al mirante (Md) Dalva Maria Carvalho Mendes.\nAssim, a MB rea&rmou seu pioneirismo, pois foi tamb ém a primeira Força que admitiu mulheres\nmilitares em seus quadros.\nComo parte do contínuo processo de atualização e ap rimoramento da administração do seu\npessoal, a Força Naval admitiu, em 2014, a primeira  turma de Aspirantes femininas da Escola\nNaval.\nForam 12 vagas específicas para o Corpo de IM, desti nadas a candidatas com idade entre 18 e 23\nanos, que tivessem concluído o ensino médio.\nAlém da formação profissional-militar, as Aspirantes  recebem aulas de Educação Física e, de\nacordo com seu desempenho, podem integrar uma das v árias equipes esportivas, como: esgrima,\nvela, remo, vôlei, basquete, orientação, atletismo, judô e tiro. As futuras Oficiais poderão participar,\nainda, de diversos grêmios, como: línguas, xadrez, comunicações, aviação, mergulho, música,\nfotografia, etc.\nAo final do curso, foram declaradas Guardas-Marinha e embarcaram no Navio-Escola “Brasil”,\nonde realizaram uma viagem de instrução de duração aproximada de seis meses, durante a qual,\ncomplementaram sua formação profissional e cultural,  tendo a oportunidade de visitar países das\nAméricas, Europa, percorrendo os Oceanos Atlântico e Pacífico, e o Mar Mediterrâneo.\nApós o regresso da viagem de instrução, as Guardas-Marinha foram nomeadas Oficiais – no posto\nde 2º Tenente – e designadas para exercerem ativida des nas diversas Organizações Militares da\nMB distribuídas ao longo de todo o território nacional.\nPor meio do Memorando n° 1, de 10 de abril de 2017,  o então Comandante da Marinha, Almirante\n\nde Esquadra Eduardo Bacellar Leal Ferreira, decidiu  ampliar a participação de Oficiais e Praças\nfemininas em atividades de aplicação efetiva do Pod er Naval, autorizando o embarque em navios\ne unidades de tropa. Dessa forma, as Oficiais passar ão a ingressar nos Corpos da Armada (CA) e\nde Fuzileiros Navais (CFN), a partir da Escola Nava l, além de fazerem parte do Corpo de\nIntendentes da Marinha (CIM), opção já aceita. As Praças femininas, também, poderão fazer parte\ndo Corpo de Praças da Armada, o que permitirá o embarque em meios do Setor Operativo.\nO Edital de 2018 trouxe vagas específicas para as mu lheres. Ingressando na Escola Naval no ano\nde 2019, ao início do 3° ano letivo, elas farão a o pção de curso e habilitação, de acordo com sua\nordem de classificação obtida no segundo ano letivo.\nAo longo dos anos, a participação das mulheres foi sendo ampliada para diversas áreas de atuação,\nincluindo a Direção de importantes Organizações Mil itares. Com equilíbrio e competência, a\nmulher marinheira vem consolidando cada vez mais su a participação nos diversos Corpos e\nQuadros dos Oficiais e Praças da Marinha do Brasil, contribuindo, sobremaneira, para o\ncumprimento das mais variadas tarefas da nossa Força, com maior eficiência e eficácia.\nhttps://www.marinha.mil.br/mulher-na-marinha",
    "statement": "Marque a alternativa que indica corretamente o empr ego da locução verbal “vem consolidando”\nno último parágrafo do texto:",
    "options": [
      {
        "letter": "A",
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "As informações transmitidas pelos grandes meios de comunicação não são recebidas de\nforma automática e da mesma maneira por todos os telespectadores.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (A) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "B",
        "text": "A síntese e as conclusões que um indivíduo vai realizar depois de assistir a uma novela não\npodem ser antecipadas por outros meios.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (B) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
      ...
      {
        "letter": "D",
        "text": "Diante da situação, fomentou-se a crença de que a televisão seria capaz de manipular de\nforma incondicionalmente uma audiência submissa, passiva e acrítica.",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial D): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      },
      {
        "letter": "E",
        "text": "A mídia é definida no contexto atual como uma complexa rede de referências em que a\ncomunicação interpessoal e a midiática se completam e transformam.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (E) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      }
    ],
  ...
  },
  {
    ...
    "questionNumber": 71,
    "readingText": "",
    "statement": "Quando há falta de certa precisão quanto aos tempos , utilizam-se algumas locuções verbais que\ntraduzem mais adequadamente o aspecto verbal. Diant e disso, a construção que expressa melhor\na noção de início de uma ação aparece no fragmento da alternativa",
    "options": [
      {
        "letter": "A",
        "text": "Puseram-se então a analisar cada um aquilo que teria de fazer no navio, ou seja, a\nmanutenção da estrutura interna; instrumentos de orientação para a navegação,\nastronomia, meteorologia; as velas, as cordas, as polias e roldanas, além dos mastros, o\nleme e os parafusos.",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial A): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      },
      {
        "letter": "B",
        "text": "As embarcações e a própria navegação em si têm sido uma das mais poderosas imagens\nna mente dos escritores.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (B) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "C",
        "text": "Não posso nem pensar na missão das escolas, as quais começam com as crianças e\ncontinuam com os cientistas, como outra que não a da realização do dito do poeta.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (C) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "D",
        "text": "Os navegadores, pobres estruturas, chamados a dar o seu palpite, ficaram em silêncio\ndiante da situação.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (D) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "E",
        "text": "Dessa forma, para navegar não basta acreditar. É preciso entender. São muitos os\nensinamentos necessários para se concretizar esse fenômeno.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (E) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      }
    ],
  ...
  },
  {
    ...
    "questionNumber": 72,
    "readingText": "",
    "statement": "Qual das alternativas abaixo apresenta a forma verb al destacada com o mesmo tempo e modo\nque a destacada no período:\n\"No entanto, não se exala o mesmo ar, mesmo que já se possa ver o outro.”",
    "options": [
      {
        "letter": "A",
        "text": "Naquele momento, pude presenciar, ao vivo, uma cena que já me tinham descrito sobre\naquele rapaz.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (A) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "B",
        "text": "Ao serem postos nessa situação, talvez acabassem por argumentar algo a respeito do\nassunto.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (B) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
      ...
      {
        "letter": "D",
        "text": "Aquele medo que lhe está tirando a tranquilidade talvez não seja fácil como os outros\npensam.",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial D): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      },
      {
        "letter": "E",
        "text": "E, assim, terminou a reunião, uma vez que nos tornamos merecedores da confiança um\ndo outro.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (E) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      }
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "letter": "D",
        "text": "O seu traje habitual era, como o de todas as mulheres da sua condição e esfera, uma saia\nde lila preta",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (D) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "E",
        "text": "em vez de lenço à cabeça, o cabelo era penteado, e seguro por um enorme pente\ncravejado de crisólitas.",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial E): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      }
    ],
  ...
  },
  {
    ...
    "questionNumber": 78,
    "readingText": "O homem deve reencontrar o Paraíso...\nRubem Alves \nEra uma família grande, todos amigos. Viviam como t odos nós: moscas presas na enorme teia de\naranha que é a vida da cidade. Todos os dias a aran ha lhes arrancava um pedaço. Ficaram\ncansados. Resolveram mudar de vida: um sonho louco:  navegar! Um barco, o mar, o céu, as\nestrelas, os horizontes sem fim: liberdade. Venderam o que tinham, compraram um barco capaz de\natravessar mares e sobreviver tempestades.\nMas para navegar não basta sonhar. É preciso saber.  São muitos os saberes necessários para se\nnavegar. Puseram-se então a estudar cada um aquilo que teria de fazer no barco: manutenção do\ncasco, instrumentos de navegação, astronomia, meteo rologia, as velas, as cordas, as polias e\nroldanas, os mastros, o leme, os parafusos, o motor , o radar, o rádio, as ligações elétricas, os\nmares, os mapas... Disse certo o poeta: Navegar é preciso, a ciência da navegação é saber preciso,\nexige aparelhos, números e medições. Barcos se fazem com precisão, astronomia se aprende com\no rigor da geometria, velas se fazem com saberes ex atos sobre tecidos, cordas e ventos,\ninstrumentos de navegação não informam mais ou menos . Assim, eles se tomaram cientistas,\nespecialistas, cada um na sua - juntos para navegar.\nChegou então o momento da grande decisão - para ond e navegar. Um sugeria as geleiras do sul\ndo Chile, outro os canais dos fiordes da Nomega, um outro queria conhecer os exóticos mares e\npraias das ilhas do Pací&co, e houve mesmo quem qui sesse navegar nas rotas de Colombo. E foi\nentão que compreenderam que, quando o assunto era a  escolha do destino, as ciências que\nconheciam para nada serviam. \nDe nada valiam números, tabelas, gráficos, estatísti cas. Os computadores, coitados, chamados a\ndar o seu palpite, ficaram em silêncio. Os computadores não têm preferências - falta-lhes essa sutil\ncapacidade de gostar, que é a essência da vida humana. Perguntados sobr e o porto de sua\nescolha, disseram que não entendiam a pergunta, que  não lhes importava para onde se estava\nindo. \n\nSe os barcos se fazem com ciência, a navegação faz- se com os sonhos. Infelizmente a ciência,\nutilíssima, especialista em saber como as coisas funcionam , tudo ignora sobre o coração humano.\nE preciso sonhar para se decidir sobre o destino da  navegação. Mas o coração humano, lugar dos\nsonhos, ao contrário da ciência, é coisa imprecisa.  Disse certo o poeta: Viver não é preciso .\nPrimeiro vem o impreciso desejo. Primeiro vem o imp reciso desejo de navegar. Só depois vem a\nprecisa ciência de navegar. \nNaus e navegação têm sido uma das mais poderosas im agens na mente dos poetas. Ezra Pound\ninicia seus Cânticos dizendo: E pois com a nau no mar/assestamos a quilha contra as vagas...\nCecília Meireles: Foi, desde sempre, o mar! A solidez da terra, monót ona/parece-nos fraca ilusão!\nQueremos a ilusão do grande mar/multiplicada em suas malhas de perigo . E Nietzsche: Amareis a\nterra de vossos .lhos, terra não descoberta, no mar  mais distante. Que as vossas velas não se\ncansem de procurar esta terra! O nosso leme nos con duz para a terra dos nossos .lhos. .. Viver é\nnavegar no grande mar! \nNão só os poetas: C. Wright Mills, um sociólogo sáb io, comparou a nossa civilização a uma galera\nque navega pelos mares. Nos porões estão os remadores. Remam com precisão cada vez maior. A\ncada novo dia recebem remos novos, mais perfeitos. O ritmo das remadas acelera. Sabem tudo\nsobre a ciência do remar. A galera navega cada vez mais rápido. Mas, perguntados sobre o porto\ndo destino, respondem os remadores: O porto não nos importa. Oque importa é a velocidad e com\nque navegamos.\nC. Wright Mills usou esta metáfora para descrever a  nossa civilização por meio duma imagem\nplástica: multiplicam-se os meios técnicos e cientí &cos ao nosso dispor, que fazem com que as\nmudanças sejam cada vez mais rápidas; mas não temos  ideia alguma de para onde navegamos.\nPara onde? Somente um navegador louco ou perdido navegaria s em ter ideia do para onde. Em\nrelação à vida da sociedade, ela contém a busca de uma utopia. Utopia, na linguagem comum, é\nusada como sonho impossível de ser realizado . Mas não é isso. Utopia é um ponto inatingível que\nindica uma direção.\nMário Quintana explicou a utopia com um verso: Se as coisas são inatingíveis... ora!/Não é motivo\npara não querê-las... Que tristes os caminhos, se n ão fora/ A mágica presença das estrelas ! Karl\nMannheim, outro sociólogo sábio que poucos leem, já  na década de 1920 diagnosticava a doença\nda nossa civilização: Não temos consciência de direções, não escolhemos d ireções. Faltam-nos\nestrelas que nos indiquem o destino.\nHoje, ele dizia, as únicas perguntas que são feitas , determinadas pelo pragmatismo da tecnologia\n(o importante é produzir o objeto) e pelo objetivis mo da ciência (o importante é saber como\nfunciona), são: Como posso fazer tal coisa? Como posso resolver este problema concreto\n\nparticular? E conclui: E em todas essas perguntas s entimos o eco otimista: não preciso de me\npreocupar com o todo, ele tomará conta de si mesmo. \nEm nossas escolas é isso que se ensina: a precisa c iência da navegação, sem que os estudantes\nsejam levados a sonhar com as estrelas. A nau naveg a veloz e sem rumo. Nas universidades, essa\ndoença assume a forma de peste epidêmica: cada espe cialista se dedica, com paixão e\ncompetência, a fazer pesquisas sobre o seu parafuso, sua polia, sua vela, seu mastro. \nDizem que seu dever é produzir conhecimento. Se for em bem-sucedidas, suas pesquisas serão\npublicadas em revistas internacionais. Quando se lh es pergunta: Para onde seu barco está\nnavegando?, eles respondem: Isso não é científico. O s sonhos não são objetos de conhecimento\ncientífico...\nE assim ficam os homens comuns abandonados por aquel es que, por conhecerem mares e\nestrelas, lhes poderíam mostrar o rumo. Não posso p ensar a missão das escolas, começando com\nas crianças e continuando com os cientistas, como outra que não a da realização do dito do poeta:\nNavegar é preciso. Viver não é preciso. \nÉ necessário ensinar os precisos saberes da navegaç ão enquanto ciência. Mas é necessário\napontar com imprecisos sinais para os destinos da navegação: A terra dos filhos dos meus filhos, no\nmar distante ... Na verdade, a ordem verdadeira é a inversa. Pri meiro, os homens sonham com\nnavegar. Depois aprendem a ciência da navegação. E inútil ensinar a ciência da navegação a quem\nmora nas montanhas...\nO meu sonho para a educação foi dito por Bachelard:  O universo tem um destino de felicidade. O\nhomem deve reencontrar o Paraíso. O paraíso é jardim, lugar de felicidade, prazeres e alegrias para\nos homens e mulheres. Mas há um pesadelo que me ato rmenta: o deserto. Houve um momento\nem que se viu, por entre as estrelas, um brilho cha mado progresso. Está na bandeira nacional... E,\nquilha contra as vagas , a galera navega em direção ao progresso, a uma ve locidade cada vez\nmaior, e ninguém questiona a direção. E é assim que  as florestas são destruídas, os rios se\ntransformam em esgotos de fezes e veneno, o ar se e nche de gases, os campos se cobrem de lixo\n- e tudo ficou feio e triste. \nSugiro aos educadores que pensem menos nas tecnologias do ensino - psicologias e quinquilharias\n- e tratem de sonhar, com os seus alunos, sonhos de um Paraíso.\nOBS.: O texto foi adaptado às regras do Novo Acordo Ortográfico.\nCom base no texto, responda à questão.",
    "statement": "Assinale a alternativa em que a forma verbal sublinhada tem um valor significativo, nocional.",
    "options": [
      {
        "letter": "A",
      ...
      {
        "letter": "E",
        "text": "(...) os rios se transformam em esgotos de fezes e veneno, o ar se enche de gases, os\ncampos se cobrem de lixo - e tudo ficou feio e triste.\n4000027268",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (E) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      }
    ],
  ...
  },
  {
    ...
    "listTitle": "PDF 7 • Verbos (Aprofundamento & Concursos)",
    "questionNumber": 86,
    "readingText": "Bruno Lichtenstein\nRubem Braga\n18 de Julho de 1939\nFoi preso o menino Bruno Lichtenstein, que arrombou  a Faculdade de Medicina. O menino Bruno\n\nLichtenstein não é arrombador profissional. Apenas a contece que o menino Bruno Lichtenstein\ntem um amigo, e esse amigo é um cachorro, e esse cachorro ia ser trucidado cientificamente, para\nestudos, na Faculdade de Medicina. O poeta mineiro Djalma Andrade tem um soneto que acaba\nmais ou menos assim:\n\"se entre os amigos encontrei cachorros,\n entre os cachorros encontrei-te, amigo\".\nMas com toda a certeza o menino Bruno Lichtenstein jamais leu esses versos. Também com\ncerteza nunca lhe explicaram o que é vivissecção, n em lhe disseram que seu cão ia ser\nvivisseccionado. Tudo o que ele sabia é que lhe hav iam carregado o cachorro e que iam matá-Io.\nSe fosse pedi-Io, naturalmente, não o dariam. Quem, neste mundo, haveria de se preocupar com o\npobre menino Bruno Lichtenstein e o seu pobre cão? Mas o cachorro era seu amigo - e estava lá,\nmetido em um porão, esperando a hora de morrer. E s ó uma pessoa no mundo podia salvá-Ia: um\nmenino pobre chamado Bruno Lichtenstein. Com esse s obrenome de principado, Bruno\nLichtenstein é um garoto sem dinheiro. Não pagará a  licença de seu amigo. Mas Bruno\nLichtenstein havia de salvar a vida de seu amigo - de qualquer jeito. E jeito só havia um: ir lá e tir ar\no cachorro. De longe, Bruno Lichtenstein chorava, p ensando ouvir o ganido triste de um\ncondenado à morte. via homens cruéis metendo o bist uri na carne quente de seu amigo: via\nsangue derramado. Horrível, horrível. Bruno Lichten stein sentiu que seria o último dos infames se\nnão agisse imediatamente.\nAgiu. Escalou uma janela, arrebentou um vidro, salt ou. Estava dentro do edifício. Andando pelas\nsalas desertas, foi até onde estava o seu amigo. Sentiu que o seu coração batia mais depressa. Deu\num assovio, um velho assovio de amizade.\nUm vulto se destacou em um salto - e um focinho e ú mido lambeu a mão de Bruno Lichtenstein.\nAgora era para a rua, para a liberdade, para a vida ... \nBruno Lichtenstein, da cabeça aos pés, tremia de su sto e de alegria. Foi aí que ele ouviu uma voz\náspera e espantada de homem. Era o dr. Loforte. O d r. Loforte surpreendeu o menino. Um menino\npodre, que tremia, que havia arrombado a Faculdade.  Só podia ser um ladrão! Bruno Lichtenstein\nnão explicou nada - e fez bem. Para o dr. Loforte um cachorro não é um cachorro - é um material\nde estudo como outro qualquer.\nNa polícia apareceu o pai do menino. O pai, o professor e o delegado conversaram longamente - e\nBruno Lichtenstein não ouvia nada. Só ouvia, lá longe, o ganir de um condenado à morte.\nJá te entregaram o cachorro, esse cachorro ia ser t rucidado cientificamente, para estudos, na\nFaculdade de Medicina. Tu o mereceste, porque tu fo ste amigo. Não te deram nem te darão\nmedalha nenhuma - porque não há medalha nenhuma par a distinguir a amizade. Mas te\n\nentregaram o teu cachorro, o cachorro que reivindic aste como um pequeno herói. Tu é um\nhomem, Bruno Lichtenstein - um homem no sentido dec ente da palavra, muito mais homem que\nmuito homem. Um aperto de mão, Bruno Lichtenstein.\nO texto acima foi extraído do livro \"1939 - Um epis ódio em Porto Alegre (Uma fada no front)\", Ed.\nRecord Rio de Janeiro, 2002 - pág. 37.",
    ...
    "options": [
      ...
      {
        "letter": "C",
        "text": "\"( ... ) esse cachorro ia ser trucidado cientificamente, para estudos, na Faculdade de\nMedicina\". (1° parágrafo)",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (C) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "\"Não te deram nem te darão medalha nenhuma (...)\". (7°parágrafo) - Não te foi dado nem\nte será dado medalha nenhuma.",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial A): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      },
      {
        "letter": "B",
        "text": "\"Só ouvia, lá longe, o ganir de um condenado à morte. (6° parágrafo) - O ganir de um\ncondenado à morte, lá longe, era ouvido por ele\".",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (B) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "C",
        "text": "\"Mas te entregaram o teu cachorro (...)\". (7° parágrafo) - Mas o teu cachorro te foi\nentregue\".",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (C) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "D",
        "text": "\"O Dr. Loforte surpreendeu o menino\". (5° parágrafo) - O menino foi surpreendido pelo Dr.\nLoforte.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (D) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "E",
        "text": "\"Também com certeza nunca lhe explicaram o que é vivissecção (...)\". (2° parágrafo) -\nTambém com certeza nunca lhe foi explicado o que é vivissecção.\n4000040085",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (E) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      }
    ],
  ...
  },
  {
    ...
    "listTitle": "PDF 7 • Verbos (Aprofundamento & Concursos)",
    "questionNumber": 88,
    "readingText": "Na minha infância tinha muito verde e os frutos era m colhidos antes de amadurecer. Nela conheci\nDeus, nela conheci o Diabo e a ambos temia nas noit es das histórias de assombração contadas\npela Maricota. Nunca pude esquecer essa pajem, cuja  imaginação abriu aos meus olhos todo um\nreino mágico que me atraia e me apavorava com a mesma violência. Com a mesma força.\nNosso assunto noturno eram as almas-penadas que per ambulavam sobre os telhados do casario\nde Sertãozinho, chão da minha meninice. Foram essas  almas as minhas primeiras personagens, de\nmistura com jovens pálidas que vomitavam sangue, us avam violetas no cabelo e dormiam com\ngelo escondido no peito porque o amado não correspo ndia: todas morriam de amor. Quando\nsoube que duas das minhas antigas tiazinhas tinham morrido do mesmo mal, comecei a achar que\nminhas histórias da adolescência não eram assim tão  originais. Contudo, continuei romântica, uma\nromântica amoitada por defesa. Pudor.\nA criação literária? Um mistério como qualquer outr o ato de criação. Ato de mistério e de amor,\noutro mistério também: nunca se sabe quando se apro xima. Quando percebemos, já estamos\ncomprometidos até a raiz dos cabelos e a solução é ir até o fim..\nAlguns dos meus contos tiveram origem numa imagem. Outros, numa simples frase que ficou\ntatuada na memória, à espera do momento propício. E xperimentos vanguardistas? Bem, sei que é\nmoda pôr em xeque a concepção da linguagem. Leio os  experimentalistas, devasso-os, corro os\nolhos pelos ensaios críticos e pelas complexas teor ias literárias. Ouço com o ouvido direito (que é\no mais lúcido) milhares de conferências e teses nos seminários de literatura, medito na palavra que\nfoi posta no paredão. Dizem uns: o branco, o ausent e é mais importante do que a frase. Vem\noutros e proclamam a morte da personagem. Morte tot al de qualquer tipo de enredo. Novos\ncódigos. Signos. Medito sobre tudo isso, anoto, ana liso experiências e pesquisas porque também\n\nsou atraída pelo canto da sereia experimentalista, buscando nela um provável instrumental que me\nestimule no aperfeiçoamento de minha escritura, para usar um termo atual.\nMas a verdade é que quando me sento para escrever, na solidão e em silêncio, tudo quanto é\nfórmula, cálculo, modelos estruturalistas - tudo é posto de lado. Esqueço. Estendo minhas antenas\ne como um inseto subindo pelo Áspero casco de uma á rvore, faço minha escolha e sigo meu\ncaminho. É difícil. É duro. Mas já optei. Carrego c omigo a alegria dessa opção. A função do\nescritor? Escrever por aqueles que não podem escrev er. Falar por aqueles que muitas vezes\nesperam ouvir da nossa boca a palavra que gostariam  de dizer. Comunicar-se com o próximo e se\npossível, mesmo através de soluções ambíguas, ajudá -los no seu sofrimento e na sua esperança.\nIsso requer amor - o amor e a piedade que o escritor deve ter no seu coração.\n(TELLES, Lygia Fagundes. O jardim selvagem)",
  ...
  },
  {
    ...
    "listTitle": "PDF 7 • Verbos (Aprofundamento & Concursos)",
    "questionNumber": 89,
    "readingText": "Vamos de mal a pior?\nAlguns só conseguem enxergar o lado feio do mundo. E, como só noticias ruins dão manchete,\ndeleitam-se em ver confirmados seus piores enredos. Mas, no que se pode medir ou contar, a\nhistória é outra. O mundo hoje está pior? Vamos com pará-lo com o de um século atrás. Jamais\nhouve tanta liberdade e o crescimento das democraci as foi extraordinário. Entre elas já não há\nguerras. Nos conCitos recentes, pelo menos um lado é ditatorial. Na última década, reduziram-se\nem 40% as guerras. Houve também dramática redução d as mortes violentas, que, no passado,\nceifavam 25% da população masculina. Hoje são só 2% . Nas pragas públicas, o povo via os\nacusados de heresia, bruxaria e magia negra serem a ssados em fogueiras. A razão e a ciência\n\najudaram a lançar luzes nessas áreas. Além disso, a  ciência hoje é capaz de captar, entender e\nresolver boa parte dos problemas materiais que afligem a humanidade ~ incluindo os desastres do\nmeio ambiente.\nAntes da Revolução Industrial, um operário só possu ía a roupa do corpo. Sua maior riqueza eram\nos pregos de sua casa. Há menos de dois séculos, um  europeu trabalhava sessenta horas por\nsemana, dos 10 anos de idade até a sua morte, por v olta dos 50 anos. Educação, cultura e lazer\nchegaram também aos pobres.\nAcabou-se a fome causada por calamidades naturais, como a que matou metade da população da\nIrlanda, no século XIX. Luís XIV não tinha a varied ade nem a qualidade do cardápio de um reles\nmembro da classe média de hoje. O povo francês cons umia 2 000 calorias por dia. Hoje, nos\npaíses pobres, consomem-se 2 700.\nHaverá algum país que estava pior que o Brasil em 1 900 e hoje lhe passou à frente? Não encontrei\nnenhum. A maioria dos países latino-americanos, inc luindo o Peru, era bem mais rica do que o\nBrasil. A renda per capita da Argentina foi cinco vezes\nmaior (hoje é quase igual). Em 1950, o Brasil era como a Bolívia de hoje. Em 1958, Cuba era o\nsegundo país mais rico da América Latina. Desde ent ão, não fez senão retroceder. E a Coreia? Na\ndécada de 50, vitima de uma medonha guerra fratricida, até os pauzinhos de comer passaram a ser\nde metal, pois não havia mais Árvores. Mas a Coreia é uma civilização milenar, com sólida tradição\nde ciência e educação. Portanto, é uma comparação d iscutível. O Brasil avançou, do último século\npara cá? Quem duvida do atraso do Brasil no passado  que leia as tenebrosas narrativas dos muitos\nvisitantes que por aqui viajaram. O século XX trans formou espetacularmente o país. Entre 1870 e\n1987 o PIB brasileiro cresceu 157 vezes, o japonês 87 e o americano 53.Brasil, campeão do mundo!\nPor volta de 1900, a esperança de vida era inferior a 30 anos. Hoje já ultrapassou 70. A desnutrição\ngrave é residual e acabaram-se as formas catastró&c as. Quase todos têm acesso a serviços\nmédicos (não tão bons, mas antes não havia nada). N os confortos materiais, houve avanços\nespetaculares. Mais de 90% têm água encanada, eletr icidade, televisão, geladeira e dezenas de\noutros confortos. Meus colegas do primário iam desc alços para a escola. Como entendeu\nSchumpeter, foram os pobres que mais ganharam qualidade de vida com o crescimento. Em 1900,\n95% das crianças (entre 7 e 14 anos) não frequentavam escolas. Hoje,\napenas 2% ficam de fora. BE, contrariando as fantasi as saudosistas, os poucos que iam\nencontravam uma escola medíocre. Hoje, continua med íocre, mas é para todos e há ilhas de\nexcelência. Crescendo junto com a educação, nossa d emocracia nunca esteve tão robusta. Nem\ntudo são rosas. Há Áreas em que somos péssimos, com o a distribuição de renda. Em matéria de\nsegurança, há oscilações. Contudo, as mortes violen tas encolheram muito. Em corrupção, faltam\ndados con&áveis. Mas, em praticamente tudo o que podemos contar ou medir, pior nado estamos.\nEssa é a tese do ensaio. Como disse lorde Rees de L udlow, “para a maior parte das pessoas, na\n\nmaior parte das nações, nunca houve um momento melhor para viver”.\nOs pessimistas que &quem com seus resmungos, pois o s avanços em praticamente todas as\ndireções estão bem medidos. Os fatos não lhes dão r azão (e, segundo o Gallup, nossa juventude é\ncampeã mundial de otimismo). Porém, não podemos fes tejar a situação presente, pois para o\nprogresso futuro precisamos ser obstinadamente inconformistas.\n(CASTRO, Cláudio de Moura. Veja, 18 fev. 2009, p. 26)",
    "statement": "No que concerne às formas verbais destacadas em: “N a última década, reduziram-se em 40% as\nguerras. Houve também dramática redução das mortes violentas, que, no passado, ceifavam 25%\nda população masculina.” (1°§S), qual afirmação está correta?",
    "options": [
      {
        "letter": "A",
        "text": "As duas formas poderiam ser empregadas tanto no pretérito perfeito, quanto no pretérito\nimperfeito, visto que, no texto, os dois tempos têm valor semântico idêntico.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (A) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "B",
        "text": "A primeira forma está no pretérito porque se refere a ação encerrada; a segunda, no\npassado, por indicar informação duvidosa.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (B) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "C",
        "text": "Ambas as formas, conjugadas na voz passiva, pertencem ao modo indicativo, o que indica\nter o autor certeza de suas afirmações.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (C) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "D",
        "text": "As duas formas referem-se a ações passadas: a primeira, no perfeito, tem limites\ndeterminados; a segunda, no imperfeito, indefinidos.",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial D): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      },
      {
        "letter": "E",
        "text": "As duas formas no pretérito ocorrem devido a necessidade de o autor tratar de duas\nações subsequentes e similares.\n4000008570",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (E) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      }
    ],
  ...
  },
  {
    ...
    "listTitle": "PDF 7 • Verbos (Aprofundamento & Concursos)",
    "questionNumber": 90,
    "readingText": "Leia atentamente o seguinte texto:\nENCONTRO NA PRAÇA \nJosé Luís da Cunha Fernandes, morador no Saco de Sã o Francisco, uma tarde dessas, teve um\nencontro singular. Ia voltar de barca para Niterói e portava sua máquina fotográfica. Sua intenção\nera pegar o pôr-do-sol no Rio de dentro da barca. M as ali na Praça 15 de Novembro, em frente à\nestação de embarque, deu-se o encontro de José Luís com uma rara personalidade. \nNinguém reparava nela, no insólito de sua presença,  no inesperado de sua postura, em tudo que\n\nera de chamar atenção. Mas José Luís, que sabe ver,  e não apenas olhar, maravilhou-se.\nMaravilhou-se e voltou imediatamente à infância, pois o ser que ali se encontrava parado em meio\nà multidão, ele o conhecera em menino, e desde entã o nunca mais o vira. Nunca. E de tanto não o\nver, por assim dizer se esquecera dele. As conversa s, as leituras, as atividades de todo dia não\ncostumam referir-se à existência dessa figura de rep ente desaparecida. Então, ela ficara\nencaixotada num desvão da memória, mas tão escondid o estava o caixote que era como se não\nexistisse. E assim se passaram anos.\nO que José Luís encontrou na Praça 15 foi uma esperança. \nE estava pousada no alto da caixa de correio. Estava pousada. \nQuantas crianças de hoje conhecem a esperança? Quantas ligam esse nome a um organismo vivo,\nque habita o folclore pela cor, que é promessa de f elicidade? Menino do interior ainda pode ver,\num dia ou outro, a esperança. Menino da cidade, ter á muita sorte se a encontrar no Alto da Boa\nVista ou no Parque da Cidade. Mas no cotidiano dos bairros superpovoados, nas ruas inteiramente\nplantadas de edifícios secos e agrestes, quem já vi u esse bichinho? Quem sabe de sua esperteza\nem imitar folhas de arbusto, iludindo não só os out ros insetos, que ele deseja papar, mas até a\ngente? \nPois em contrário a todas as possibilidades, a esperança postara-se naquele trecho febril do Rio de\nJaneiro, não ligando para o tumulto, a pressa, o ba rulho, a poeira, o fumo de descarga dos\nveículos. Ele elegera o cocuruto da caixa da ECT pa ra a habitação provisória. Ali estava, quieta,\nverde, ortóptera, saltadora mas imóvel, mimética ma s em sua cor natural, estridulante mas\nsilenciosa, guardando todas as potencialidades: sim plesmente esperança, esperança para servi-\nlos. \nE em que servia a esperança ao povo que ia quase co rrendo e não lhe dava a mínima confiança?\nSó José Luís era capaz de sabê-lo, por ser o único a tomar conhecimento do inseto em cima da\ncaixa. Percebeu logo que a esperança cumpria delicada tarefa.\nEm primeiro lugar, oferecia ou tentava oferecer boa s notícias nas cartas colocadas no interior da\ncaixa. Palavras de carinho, promessas de emprego, r econciliações, doente que ficou bom, dívida\nque se conseguir pagar, beijos. Talvez as cartas di ssessem o contrário disso, mas a esperança\nconcentrava seu princípio influente nas próximas cor respondências, as definitivas. Bem que a ECT\npodia designar a esperança para seu logotipo. Inset o ágil, pulando como ele só: imagem de\nvelocidade, que se vem conseguindo implantar no tráfego postal. \nEm seguida, a esperança dirigia-se a todos, que vol tavam a Niterói ou vinham de lá; e ainda aos\navulsos, que ficam por aqui mesmo, e transitam na Pr aça. “Ó vós todos que passais, aqui estou\n(dizia a esperança em seu falar tetigonídeo, que o vulgo infelizmente não capisca) para que\n\nrepareis o meu verde e o guardeis na rotina pelo que ele vale. Vale o melhor. Vale a capacidade de\ntransformar o real em transreal e usufruir as coisa s deleitáveis que esse pode distribuir em forma\nde paz de espírito e coração sensível. Nem tudo é s ujo na vida. Há claridades. Mas a claridade\ncomeça dentro de você, de vós mesmos... Depois é que ela se espalha pela cidade e pela vida dos\noutros. Eu, a esperança, à maneira dos reis antigos, vos envio saudar.” \nNinguém ouviu, ninguém traduziu. Só José Luís, que documentou a presença da esperança,\nfotografando-a. Ia fotografar o crepúsculo, mas ant es teve a sorte de fotografar nada menos que\numa virtude teologal em minúscula forma vivente. \nCarlos Drummond de Andrade",
    "statement": "Lido o texto, observe atentamente o quesito e assinale somente UMA alternativa correta \nA s formas verbais sublinhadas apresentam-se no in&nitivo, à exceção de uma, que aparece na\nopção:",
    "options": [
      {
        "letter": "A",
      ...
      {
        "letter": "B",
        "text": "“As conversas, as leituras, as atividades de todo dia não costumam referir-se à existência\ndessa figura.”",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (B) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
      ...
      {
        "letter": "D",
        "text": "“Menino da cidade terá muita sorte se a encontrar no Alto da Boa Vista ou no Parque da\nCidade.”",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial D): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      },
      {
  ...
  },
  {
    ...
    "questionNumber": 91,
    "readingText": "Leia atentamente o seguinte texto:\nENCONTRO NA PRAÇA \nJosé Luís da Cunha Fernandes, morador no Saco de Sã o Francisco, uma tarde dessas, teve um\nencontro singular. Ia voltar de barca para Niterói e portava sua máquina fotográfica. Sua intenção\nera pegar o pôr-do-sol no Rio de dentro da barca. M as ali na Praça 15 de Novembro, em frente à\nestação de embarque, deu-se o encontro de José Luís com uma rara personalidade. \nNinguém reparava nela, no insólito de sua presença,  no inesperado de sua postura, em tudo que\nera de chamar atenção. Mas José Luís, que sabe ver,  e não apenas olhar, maravilhou-se.\nMaravilhou-se e voltou imediatamente à infância, pois o ser que ali se encontrava parado em meio\n\nà multidão, ele o conhecera em menino, e desde entã o nunca mais o vira. Nunca. E de tanto não o\nver, por assim dizer se esquecera dele. As conversa s, as leituras, as atividades de todo dia não\ncostumam referir-se à existência dessa figura de rep ente desaparecida. Então, ela ficara\nencaixotada num desvão da memória, mas tão escondid o estava o caixote que era como se não\nexistisse. E assim se passaram anos.\nO que José Luís encontrou na Praça 15 foi uma esperança. \nE estava pousada no alto da caixa de correio. Estava pousada. \nQuantas crianças de hoje conhecem a esperança? Quantas ligam esse nome a um organismo vivo,\nque habita o folclore pela cor, que é promessa de f elicidade? Menino do interior ainda pode ver,\num dia ou outro, a esperança. Menino da cidade, ter á muita sorte se a encontrar no Alto da Boa\nVista ou no Parque da Cidade. Mas no cotidiano dos bairros superpovoados, nas ruas inteiramente\nplantadas de edifícios secos e agrestes, quem já vi u esse bichinho? Quem sabe de sua esperteza\nem imitar folhas de arbusto, iludindo não só os out ros insetos, que ele deseja papar, mas até a\ngente? \nPois em contrário a todas as possibilidades, a esperança postara-se naquele trecho febril do Rio de\nJaneiro, não ligando para o tumulto, a pressa, o ba rulho, a poeira, o fumo de descarga dos\nveículos. Ele elegera o cocuruto da caixa da ECT pa ra a habitação provisória. Ali estava, quieta,\nverde, ortóptera, saltadora mas imóvel, mimética ma s em sua cor natural, estridulante mas\nsilenciosa, guardando todas as potencialidades: sim plesmente esperança, esperança para servi-\nlos. \nE em que servia a esperança ao povo que ia quase co rrendo e não lhe dava a mínima confiança?\nSó José Luís era capaz de sabê-lo, por ser o único a tomar conhecimento do inseto em cima da\ncaixa. Percebeu logo que a esperança cumpria delicada tarefa.\nEm primeiro lugar, oferecia ou tentava oferecer boa s notícias nas cartas colocadas no interior da\ncaixa. Palavras de carinho, promessas de emprego, r econciliações, doente que ficou bom, dívida\nque se conseguir pagar, beijos. Talvez as cartas di ssessem o contrário disso, mas a esperança\nconcentrava seu princípio influente nas próximas cor respondências, as definitivas. Bem que a ECT\npodia designar a esperança para seu logotipo. Inset o ágil, pulando como ele só: imagem de\nvelocidade, que se vem conseguindo implantar no tráfego postal. \nEm seguida, a esperança dirigia-se a todos, que vol tavam a Niterói ou vinham de lá; e ainda aos\navulsos, que ficam por aqui mesmo, e transitam na Pr aça. “Ó vós todos que passais, aqui estou\n(dizia a esperança em seu falar tetigonídeo, que o vulgo infelizmente não capisca) para que\nrepareis o meu verde e o guardeis na rotina pelo que ele vale. Vale o melhor. Vale a capacidade de\ntransformar o real em transreal e usufruir as coisa s deleitáveis que esse pode distribuir em forma\n\nde paz de espírito e coração sensível. Nem tudo é s ujo na vida. Há claridades. Mas a claridade\ncomeça dentro de você, de vós mesmos... Depois é que ela se espalha pela cidade e pela vida dos\noutros. Eu, a esperança, à maneira dos reis antigos, vos envio saudar.” \nNinguém ouviu, ninguém traduziu. Só José Luís, que documentou a presença da esperança,\nfotografando-a. Ia fotografar o crepúsculo, mas ant es teve a sorte de fotografar nada menos que\numa virtude teologal em minúscula forma vivente. \nCarlos Drummond de Andrade",
    "statement": "Lido o texto, observe atentamente o quesito e assinale somente UMA alternativa correta \nN a transposição d a voz ativa para a voz passiva oco rre uma INADEQUAÇÃO, que aparece na\nopção:",
    "options": [
      {
        "letter": "A",
        "text": "“Percebeu logo que a esperança cumpria delicada tarefa.” Percebeu logo que delicada\ntarefa era cumprida pela esperança.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (A) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "B",
        "text": "“Talvez as cartas dissessem o contrário disso.” O contrário disso talvez fosse dito pelas\ncartas.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (B) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
      ...
      {
        "letter": "D",
        "text": "“Quantas crianças de hoje conhecem a esperança?” A esperança é conhecida por\nquantas crianças de hoje?",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (D) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "E",
        "text": "“E elegera o cocoruto da caixa da ECT como habitação provisória.” E o cocoruto da caixa\nda ECT fora elegido como habitação provisória.\n4000040013",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial E): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      }
    ],
  ...
  },
  {
    ...
    "questionNumber": 1,
    "readingText": "",
    "statement": "Assinale a alternativa cujos verbos completam corretamente as seguintes frases: \n• Se ninguém  nesse caso, sabe lá Deus que fim terá. \n• No mesmo dia, ele  os documentos que perdera. \n• Foram designados alguns advogados para que  a banca \nexaminadora.",
    "options": [
      {
        "letter": "A",
  ...
  },
  {
    ...
    "questionNumber": 3,
    "readingText": "",
    "statement": "Leia: \nE como ontem estivesse chovendo, tive a infeliz ideia, ao sair à rua, de calçar um \nvelho par de galochas. Já me desacostumara delas, e me sentia a carregar nos pés \nalgo pesado, viscoso e desagradável. \nOs verbos destacados acima estão, respectivamente, no",
    "options": [
      {
        "letter": "A",
        "text": "pretérito perfeito do indicativo / pretérito imperfeito do subjuntivo / futuro do \npresente do indicativo / presente do subjuntivo.",
        "correct": false,
        "explanation": "✗ INCORRETO: Diverge da classificação sequencial exata dos quatro tempos pretéritos empregados no fragmento."
      },
      {
        "letter": "B",
        "text": "pretérito imperfeito do subjuntivo / pretérito imperfeito do indicativo / pretérito \nperfeito do indicativo / pretérito imperfeito do indicativo.",
        "correct": false,
        "explanation": "✗ INCORRETO: Diverge da classificação sequencial exata dos quatro tempos pretéritos empregados no fragmento."
      },
      {
        "letter": "C",
        "text": "pretérito perfeito do indicativo / pretérito perfeito do indicativo / pretérito mais- \nque-perfeito do indicativo / pretérito perfeito do indicativo.",
        "correct": false,
        "explanation": "✗ INCORRETO: Diverge da classificação sequencial exata dos quatro tempos pretéritos empregados no fragmento."
      },
      {
        "letter": "D",
        "text": "pretérito imperfeito do subjuntivo / pretérito perfeito do indicativo / pretérito \nmais-que-perfeito do indicativo / pretérito imperfeito do indicativo.",
        "correct": true,
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "futuro do presente do indicativo – presente do subjuntivo – futuro do presente do \nindicativo.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (A) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "B",
        "text": "pretérito imperfeito do subjuntivo – pretérito imperfeito do subjuntivo – futuro do \nsubjuntivo.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (B) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "C",
        "text": "pretérito perfeito do indicativo – pretérito imperfeito do indicativo – futuro do \npretérito do indicativo.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (C) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "D",
        "text": "pretérito mais-que-perfeito do indicativo – pretérito imperfeito do subjuntivo – \nfuturo do pretérito do indicativo.",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial D): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      }
    ],
  ...
  },
  {
    ...
    "questionNumber": 15,
    "readingText": "",
    "statement": "Leia: Amigos, um passeio numa máquina do tempo não seria divertido? \nNão seria incrível? Imaginem se, numa das viagens, vocês pudessem encontrar um \npersonagem importante da história, como Einstein, e ajudá-lo a elaborar suas teorias! \nJá pensaram nisso? As formas verbais destacadas no texto acima estão conjugadas, \nrespectivamente, no",
    "options": [
      {
        "letter": "A",
        "text": "futuro do presente do indicativo / presente do subjuntivo / pretérito imperfeito do \nindicativo.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (A) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "B",
        "text": "futuro do pretérito do indicativo / imperativo afirmativo / pretérito imperfeito do \nsubjuntivo.",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial B): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      },
      {
        "letter": "C",
        "text": "pretérito imperfeito do subjuntivo / presente do subjuntivo / pretérito perfeito do \nindicativo.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (C) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "letter": "C",
        "text": "No imperativo, pois os verbos destacados estão exprimindo ordem, conselho e \npedido.",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial C): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      },
      {
  ...
  },
  {
    ...
    "questionNumber": 20,
    "readingText": "",
    "statement": "Leia: \n“Se soubésseis o quanto era aprazível ouvir, mergulhar nas histórias de minha velha \navó,  não só os ouvidos, mas cada centímetro do 'lado de dentro do corpo' \na pulsar com tudo o que sua voz desenhava.” \nComplete o espaço demarcado no texto com a correta conjugação do verbo pôr.",
    "options": [
      {
        "letter": "A",
        "text": "Poriam",
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "letter": "C",
        "text": "Acordou de madrugada, esperando que alguém lhe  um copo \nd’água. (dar)",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (C) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "D",
        "text": "O encarregado me denunciou para o patrão: disse que eu sempre \n  atrasado. (chegar)",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial D): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      }
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "letter": "C",
        "text": "Se ela reavesse o dinheiro que perdeu, iria investi-lo em uma aplicação de baixo \nrisco.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (C) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "D",
        "text": "Se eles expuserem os riscos do mercado para mim, poderei analisar a situação com \nmais segurança.",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial D): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      }
    ],
  ...
  },
  {
    ...
    "questionNumber": 24,
    "readingText": "",
    "statement": "Leia: \n \n“Sentia-se cansada. A barriga, as pernas, a cabeça, o corpo todo era um enorme peso \nque lhe caía irremediavelmente em cima. Esperava que a qualquer momento o \ncoração lhe perfurasse o peito, lhe rasgasse a blusa. Como seria o coração?” (Dina \nSalústio) \nOs verbos destacados no texto acima estão conjugados, respectivamente, no",
    "options": [
      {
        "letter": "A",
        "text": "pretérito perfeito do indicativo - pretérito imperfeito do indicativo - pretérito \nimperfeito do indicativo - futuro do presente do indicativo",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (A) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "B",
        "text": "pretérito imperfeito do indicativo - pretérito imperfeito do subjuntivo - futuro do \npretérito do indicativo - pretérito imperfeito do subjuntivo.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (B) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "C",
        "text": "pretérito-mais-que-perfeito do indicativo - pretérito imperfeito do indicativo - \nfuturo do subjuntivo - pretérito imperfeito do subjuntivo.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (C) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "D",
        "text": "pretérito imperfeito do indicativo - pretérito imperfeito do indicativo - pretérito \nimperfeito do subjuntivo - futuro do pretérito do indicativo.",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial D): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      }
    ],
  ...
  },
  {
    ...
    "questionNumber": 28,
    "readingText": "",
    "statement": "Voltem logo para casa hoje, meninas, pois meus \npais exigem que estejam presentes à cerimônia de formatura do meu irmão à \nnoite, na faculdade. Vocês não podem faltar, ou eles ficarão aborrecidos. \nOs verbos destacados encontram-se conjugados, respectivamente, no",
    "options": [
      {
        "letter": "A",
        "text": "presente do subjuntivo, imperativo afirmativo, presente do subjuntivo, presente \ndo indicativo.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (A) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "B",
        "text": "imperativo afirmativo, presente do indicativo, presente do subjuntivo, presente do \nindicativo.",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial B): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      },
      {
        "letter": "C",
        "text": "presente do subjuntivo, imperativo afirmativo, presente do indicativo, imperativo \nafirmativo.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (C) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "D",
        "text": "imperativo afirmativo, presente do indicativo, presente do indicativo, imperativo \nafirmativo.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (D) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      }
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "letter": "D",
        "text": "Diante do fervor dos ânimos, eu intervim para que a situação não ficasse \nmais complicada.",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial D): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      }
    ],
  ...
  },
  {
    ...
    "listTitle": "PDF 17 • Modos Verbais II",
    "questionNumber": 6,
    "readingText": "6) Leia o fragmento seguinte e responda a questão: “Ele chegara a afirmar, em \noutro episódio, que era uma “luta perdida”.”",
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "letter": "B",
        "text": "Futuro do pretérito do indicativo, presente do subjuntivo, imperfeito \ndo subjuntivo.",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial B): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      },
      {
      ...
      {
        "letter": "D",
        "text": "Pretérito Imperfeito do indicativo, imperfeito do subjuntivo, imperfeito \ndo indicativo.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (D) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      }
    ],
  ...
  },
  {
    ...
    "questionNumber": 12,
    "readingText": "",
    "statement": "Assinale a alternativa que preenche as lacunas corretamente. \n \nI – Ele ficará maravilhado se  o resultado.(ver) \nII- Nós lhe daremos o recado assim que ele  aqui. (vir)",
    "options": [
      {
        "letter": "A",
        "text": "Vir, vir .",
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "Ao digitar as senhas em público, é necessário que confiremos se há \npessoas estranhas nos observando para garantir a segurança virtual.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (A) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "B",
        "text": "As informações pessoais deveriam ser digitadas de forma condensada para que \ncabessem todas no espaço próprio do questionário socioeconômico.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (B) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "C",
        "text": "Os meios eletrônicos contribuem para que os estudantes retenham a maior parte \ndas informações necessárias ao bom desempenho escolar.",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial C): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      },
      {
        "letter": "D",
        "text": "Para evitar a espionagem virtual é preciso que nós não consintemos na utilização \ndos nossos dados pessoais ao instalar novos aplicativos no celular.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (D) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "E",
        "text": "Quando algum consumidor querer comprar o último modelo de smartphone, pode \nagredir outros componentes da fila para tomar seu lugar.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (E) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      }
    ],
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "Os grevistas se manteram na entrada da fábrica durante todo o horário \ndo expediente.",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (A) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "pretérito perfeito do indicativo; pretérito imperfeito do indicativo; futuro \ndo presente do indicativo",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (A) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "B",
        "text": "pretérito mais-que-perfeito do indicativo; pretérito perfeito do \nindicativo; presente do indicativo",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (B) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "C",
        "text": "pretérito imperfeito do indicativo; pretérito imperfeito do indicativo; futuro do \npresente do indicativo",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial C): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      },
      {
        "letter": "D",
        "text": "pretérito perfeito do indicativo; pretérito perfeito do indicativo; futuro \ndo pretérito do indicativo",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (D) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "E",
        "text": "pretérito mais-que-perfeito do indicativo; pretérito imperfeito do \nindicativo; presente do indicativo",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (E) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      }
    ],
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "Um dia após o terremoto, o governo da Indonésia declarou estado de emergência. ( \npresente do indicativo)",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (A) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "B",
        "text": "A Copa da Cultura animará Berlim durante a copa do mundo. (futuro do presente \ndo indicativo)",
        "correct": true,
        "explanation": "✓ CORRETO (Gabarito Oficial B): Esta alternativa atende rigorosamente à norma-padrão gramatical e às regras de flexão, modo ou aspecto verbal solicitadas no enunciado."
      },
      {
        "letter": "C",
        "text": "O governo federal anuncia R$ 10 bilhões para a agricultura familiar. (pretérito \nmais-que-perfeito do indicativo)",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (C) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
        "letter": "D",
        "text": "As crianças que estavam descalças tremeram de frio. (pretérito perfeito \ndo indicativo)",
        "correct": false,
        "explanation": "✗ INCORRETO: A alternativa (D) apresenta inadequação de flexão verbal, tempo, modo, concordância ou regência conforme a gramática normativa."
      },
      {
  ...
  },
  {
    ...
    "questionNumber": 27,
    "readingText": "",
    "statement": "Assinale a alternativa que completa corretamente a seguinte frase. “Quando \n mais aperfeiçoados, os aviões, certamente, maior conforto e segurança \n em qualquer viagem.”",
    "options": [
      {
        "letter": "A",
